...
WANT = [
    ...
    # v1.5 playtests. Addresses move every rebuild; suites must read these from symbols.lua.
    "gMPlayInfo_BGM", "gSongTable", "gWildMonHeaders",
    "gTileset_PokemonCenterFrlg", "gTileset_Kanto_PokemonCenter",
    "gTileset_PokemonCenter_White", "gTileset_TrainerTower", "gTileset_PokemonCenter",
    ...
    "Task_OakSpeech_HandleGenderInput", "Task_OakSpeech_HandleOutfitInput",
    "Task_OakSpeech_HandleHardModeInput", "Task_OakSpeech_ShowHardModeYesNo",
    "Task_OakSpeech_AskHardMode", "Task_EvIvChangerHandleInput",
    "sCondMsg51", "sCondMsg52", "sCondMsg53",
    ...
    "gSaveAttemptStatus", "gSaveCounter",
    "gReadWriteSector", "gDamagedSaveSectors", "gLastWrittenSector",
    "sGlobalScriptContextStatus",
    "sSecondaryTilesetAnimCallback", "sSecondaryTilesetAnimCounter",
    "sCondMsg43", "EventScript_Follower",
    "CB2_InitPartyMenu", "CB2_Bag",
