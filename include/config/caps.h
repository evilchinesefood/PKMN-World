...
// Level Cap Configs
// QoL #16: the three caps below are compiled in but runtime-gated on the HARD MODE
// option (gSaveBlock2Ptr->optionsHardMode) inside src/caps.c - with the option OFF,
...
// EV Cap Configs
#define B_EV_CAP_TYPE                   EV_CAP_NONE   // [EV_CAP_NONE, EV_CAP_FLAG_LIST, EV_CAP_VARIABLE, EV_CAP_NO_GAIN] choose the type of EV cap to apply
