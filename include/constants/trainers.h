...
enum
{
    ...
    FACILITY_CLASS_BLUE,
    FACILITY_CLASS_LANCE,
    FACILITY_CLASS_LORELEI,
    FACILITY_CLASS_AGATHA,
    FACILITY_CLASS_GLACIA,
    FACILITY_CLASS_DRAKE,
    FACILITY_CLASS_KAREN,
    FACILITY_CLASS_WILL,
    FACILITY_CLASS_SABRINA,
    FACILITY_CLASS_ROCKET,
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_LEADER_JOHTO,
    TRAINER_CLASS_CHAMPION_JOHTO,
    TRAINER_CLASS_ELITE_FOUR_JOHTO,
    TRAINER_CLASS_RIVAL_JOHTO,
