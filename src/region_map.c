...
// Kanto Red/Leaf region-map icons removed (deep-review task 23): the merge is Brendan/May-only.
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_JOHTO_VICTORY_ROAD] = {MAP_GROUP(MAP_JOHTO_VICTORY_ROAD_1F), MAP_NUM(MAP_JOHTO_VICTORY_ROAD_1F), HEAL_LOCATION_NONE},
    [MAPSEC_JOHTO_INDIGO_PLATEAU] = {MAP_GROUP(MAP_JOHTO_INDIGO_PLATEAU), MAP_NUM(MAP_JOHTO_INDIGO_PLATEAU), HEAL_LOCATION_JOHTO_INDIGO_PLATEAU},
};
...
void CreateRegionMapPlayerIcon(u16 tileTag, u16 paletteTag)
{
    ...
    // Deep-review task 23: the merge uses Brendan/May everywhere (Emerald base), so the region-map
    // player icon must too. Dropped the Kanto Red/Leaf branches - the default sheet is Brendan and
    // FEMALE selects May.
...
static const struct FlyLocation sFlyLocations[] =
{
    ...
    {
        .regionMapType = REGION_MAP_JOHTO,
        .mapsec = MAPSEC_JOHTO_INDIGO_PLATEAU,
        .flag = FLAG_VISITED_INDIGO_PLATEAU,
    },
};
