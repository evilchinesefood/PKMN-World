#!/usr/bin/env python3
"""Build an isolated #336 fixture and record the actual input ROM's source revision."""
import argparse
import hashlib
import json
import subprocess
...
m['fixture_header_context'] = {str(f): hashlib.sha256((a.repo / f).read_bytes()).hexdigest()
    for f in ('include/config/battle.h', 'include/battle.h',
              'include/text.h', 'include/sprite.h', 'include/config/swsh_item_menu.h')}
