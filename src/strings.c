...
const u8 gText_DexHoennTitle[] = _("REGION DEX");
...
const u8 gText_DexHoennDescription[] = _("your region's POKéDEX");
...
#if POKEVIAL_FEATURE
const u8 gText_PokevialHasDoses[] = _("The {STR_VAR_1} has {STR_VAR_2} heals left.\nUse the {STR_VAR_1}?");
