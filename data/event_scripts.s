...
@ FRLG scripts
	...
	@ Region merge (Johto port): Goldenrod area scripts.
	...
	@ Region merge (Johto port): Ecruteak area scripts.
	...
	@ Region merge (Johto port): Mahogany area scripts.
	...
	@ Region merge (Johto port): Blackthorn area scripts.
	...
	@ Region merge (Johto port): Safari Zone area scripts.
	...
	@ Region merge (Johto port): Mt Silver area scripts.
	...
	.include "data/maps/RegionHub_2F/scripts.inc"
...
.endif
	...
	.include "data/scripts/battle_net.inc"
...
EventScript_SetBrineyLocation_Route109::
	...
	.include "data/scripts/pkmn_center_chansey.inc"
