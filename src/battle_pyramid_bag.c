...
// Reserve all 25 SwSh frame tiles after the largest Pyramid action window. The classic frame also fits.
#define PYRAMID_BAG_DLG_WINDOW_BASE_TILE_NUM (472 + 14 * 6)
