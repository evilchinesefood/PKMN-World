...
static const u32 sMoveFrame_Gfx[]                   = INCGFX_U32("graphics/summary_screen/swsh/move_frame.png", ".4bpp.smol");
...
static void UpdateMoveSlotPalette(void)
{
    ...
    u8 hoverPalSlot = IndexOfSpritePaletteTag(TAG_DYNAMAX_LEVELS);
