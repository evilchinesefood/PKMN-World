...
local function killWeather()
  ...
  F.w8(S.gWeather + WEATHER_CURR, WEATHER_NONE)
  F.w8(S.gWeather + WEATHER_NEXT, WEATHER_NONE)
  F.w8(S.gWeather + WEATHER_TARGET_RAIN, 0)
  F.w8(S.gWeather + WEATHER_RAIN_COUNT, 0)
end
