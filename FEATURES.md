...
- **Saffron Dojo Hitmons and Mt. Moon fossils are both obtainable.** Taking one no longer
  locks the other. Miguel does not steal the leftover fossil. Fuchsia’s fossil sign shows
  both species if you own both. Regional starters (Oak, Elm, Route 101 Birch, Birch’s
  post-National Dex Johto trio) stay one-choice.
