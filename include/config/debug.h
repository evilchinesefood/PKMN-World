...
// Overworld Debug
#define DEBUG_OVERWORLD_MENU            DISABLED_ON_RELEASE // On in dev/playtest builds (hold R + START in the overworld), off under `make RELEASE=1` so a shipped ROM can't corrupt saves via the debug menu.
