...
#define I_KEY_ITEM_WHEEL                FALSE       // If TRUE, enables the ORAS-style SELECT registration wheel: up to I_MAX_REGISTERED_ITEMS key items can be registered to SELECT (one per D-Pad direction). NOTE: adds I_MAX_REGISTERED_ITEMS-1 u16s to SaveBlock1.
