...
#define FLAG_SYS_GAME_CLEAR                          (SYSTEM_FLAGS + 0x4) // any-region first HOF; gates cross-region conveniences and flavour. Region STORY gates on FLAG_<REGION>_CHAMPION -- see #206
...
#define FLAG_SYS_BUG_CONTEST_MODE                   (SYSTEM_FLAGS + 0x21) // Region merge (Johto port): active during the National Park Bug-Catching Contest
...
// === Region-merge Kanto flag bank (ALL_REGIONS only) — AUTO-GENERATED by
// ~/python/RegionMerge/GenKantoFlagBank.py. Rebases the FRLG flag namespace into a
// dedicated bank above the Hoenn range so both regions coexist in one SaveBlock.
#if ALL_REGIONS

#undef FLAG_HIDDEN_ITEMS_START
#define FLAG_HIDDEN_ITEMS_START 0xF00

// Hoenn hidden items relocated (delta from FLAG_HIDDEN_ITEMS_START preserved)
#undef FLAG_HIDDEN_ITEM_LAVARIDGE_TOWN_ICE_HEAL
#define FLAG_HIDDEN_ITEM_LAVARIDGE_TOWN_ICE_HEAL (FLAG_HIDDEN_ITEMS_START + 0x0)
#undef FLAG_HIDDEN_ITEM_TRICK_HOUSE_NUGGET
#define FLAG_HIDDEN_ITEM_TRICK_HOUSE_NUGGET (FLAG_HIDDEN_ITEMS_START + 0x1)
#undef FLAG_HIDDEN_ITEM_ROUTE_111_STARDUST
#define FLAG_HIDDEN_ITEM_ROUTE_111_STARDUST (FLAG_HIDDEN_ITEMS_START + 0x2)
#undef FLAG_HIDDEN_ITEM_ROUTE_113_ETHER
#define FLAG_HIDDEN_ITEM_ROUTE_113_ETHER (FLAG_HIDDEN_ITEMS_START + 0x3)
#undef FLAG_HIDDEN_ITEM_ROUTE_114_CARBOS
#define FLAG_HIDDEN_ITEM_ROUTE_114_CARBOS (FLAG_HIDDEN_ITEMS_START + 0x4)
#undef FLAG_HIDDEN_ITEM_ROUTE_119_CALCIUM
#define FLAG_HIDDEN_ITEM_ROUTE_119_CALCIUM (FLAG_HIDDEN_ITEMS_START + 0x5)
#undef FLAG_HIDDEN_ITEM_ROUTE_119_ULTRA_BALL
#define FLAG_HIDDEN_ITEM_ROUTE_119_ULTRA_BALL (FLAG_HIDDEN_ITEMS_START + 0x6)
#undef FLAG_HIDDEN_ITEM_ROUTE_123_SUPER_REPEL
#define FLAG_HIDDEN_ITEM_ROUTE_123_SUPER_REPEL (FLAG_HIDDEN_ITEMS_START + 0x7)
#undef FLAG_HIDDEN_ITEM_UNDERWATER_124_CARBOS
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_CARBOS (FLAG_HIDDEN_ITEMS_START + 0x8)
#undef FLAG_HIDDEN_ITEM_UNDERWATER_124_GREEN_SHARD
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_GREEN_SHARD (FLAG_HIDDEN_ITEMS_START + 0x9)
#undef FLAG_HIDDEN_ITEM_UNDERWATER_124_PEARL
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_PEARL (FLAG_HIDDEN_ITEMS_START + 0xA)
#undef FLAG_HIDDEN_ITEM_UNDERWATER_124_BIG_PEARL
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_BIG_PEARL (FLAG_HIDDEN_ITEMS_START + 0xB)
#undef FLAG_HIDDEN_ITEM_UNDERWATER_126_BLUE_SHARD
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_BLUE_SHARD (FLAG_HIDDEN_ITEMS_START + 0xC)
#undef FLAG_HIDDEN_ITEM_UNDERWATER_124_HEART_SCALE_1
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_HEART_SCALE_1 (FLAG_HIDDEN_ITEMS_START + 0xD)
#undef FLAG_HIDDEN_ITEM_UNDERWATER_126_HEART_SCALE
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_HEART_SCALE (FLAG_HIDDEN_ITEMS_START + 0xE)
#undef FLAG_HIDDEN_ITEM_UNDERWATER_126_ULTRA_BALL
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_ULTRA_BALL (FLAG_HIDDEN_ITEMS_START + 0xF)
...
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_B2F_MAX_REPEL (FLAG_HIDDEN_ITEMS_START + 0x53)
// Each region's Victory Road needs its own hidden-item bits: sharing 0x51-0x53 across
// the three campaigns marked every copy collected when any one was picked up. Hoenn
// keeps the original offsets; Kanto/Johto get free slots (0x9B-0x9E verified unused).
#define FLAG_HIDDEN_ITEM_KANTO_VICTORY_ROAD_1F_ULTRA_BALL (FLAG_HIDDEN_ITEMS_START + 0x9B)
#define FLAG_HIDDEN_ITEM_JOHTO_VICTORY_ROAD_1F_ULTRA_BALL (FLAG_HIDDEN_ITEMS_START + 0x9C)
#define FLAG_HIDDEN_ITEM_JOHTO_VICTORY_ROAD_B2F_ELIXIR (FLAG_HIDDEN_ITEMS_START + 0x9D)
#define FLAG_HIDDEN_ITEM_JOHTO_VICTORY_ROAD_B2F_MAX_REPEL (FLAG_HIDDEN_ITEMS_START + 0x9E)
...
// FRLG-only flags rebased into the Kanto bank; hidden items appended after Hoenn's.
#undef FLAG_HIDE_BULBASAUR_BALL
#define FLAG_HIDE_BULBASAUR_BALL (0xA40 + 0x28)
#undef FLAG_HIDE_SQUIRTLE_BALL
#define FLAG_HIDE_SQUIRTLE_BALL (0xA40 + 0x29)
#undef FLAG_HIDE_CHARMANDER_BALL
#define FLAG_HIDE_CHARMANDER_BALL (0xA40 + 0x2A)
#undef FLAG_HIDE_OAK_IN_HIS_LAB
#define FLAG_HIDE_OAK_IN_HIS_LAB (0xA40 + 0x2B)
#undef FLAG_HIDE_OAK_IN_PALLET_TOWN
#define FLAG_HIDE_OAK_IN_PALLET_TOWN (0xA40 + 0x2C)
#undef FLAG_HIDE_RIVAL_IN_LAB
#define FLAG_HIDE_RIVAL_IN_LAB (0xA40 + 0x2D)
#undef FLAG_HIDE_PEWTER_CITY_GYM_GUIDE
#define FLAG_HIDE_PEWTER_CITY_GYM_GUIDE (0xA40 + 0x2E)
#undef FLAG_HIDE_DOME_FOSSIL
#define FLAG_HIDE_DOME_FOSSIL (0xA40 + 0x2F)
#undef FLAG_HIDE_HELIX_FOSSIL
#define FLAG_HIDE_HELIX_FOSSIL (0xA40 + 0x30)
#undef FLAG_HIDE_NUGGET_BRIDGE_ROCKET
#define FLAG_HIDE_NUGGET_BRIDGE_ROCKET (0xA40 + 0x31)
#undef FLAG_HIDE_BILL_CLEFAIRY
#define FLAG_HIDE_BILL_CLEFAIRY (0xA40 + 0x32)
#undef FLAG_HIDE_BILL_HUMAN_SEA_COTTAGE
#define FLAG_HIDE_BILL_HUMAN_SEA_COTTAGE (0xA40 + 0x33)
#undef FLAG_HIDE_TOWER_FUJI
#define FLAG_HIDE_TOWER_FUJI (0xA40 + 0x34)
#undef FLAG_HIDE_POKEHOUSE_FUJI
#define FLAG_HIDE_POKEHOUSE_FUJI (0xA40 + 0x35)
#undef FLAG_HIDE_LIFT_KEY
#define FLAG_HIDE_LIFT_KEY (0xA40 + 0x36)
#undef FLAG_HIDE_SILPH_SCOPE
#define FLAG_HIDE_SILPH_SCOPE (0xA40 + 0x37)
#undef FLAG_HIDE_HIDEOUT_GIOVANNI
#define FLAG_HIDE_HIDEOUT_GIOVANNI (0xA40 + 0x38)
#undef FLAG_HIDE_TOWN_MAP
#define FLAG_HIDE_TOWN_MAP (0xA40 + 0x39)
#undef FLAG_HIDE_POKEDEX
#define FLAG_HIDE_POKEDEX (0xA40 + 0x3A)
#undef FLAG_HIDE_CERULEAN_ROCKET
#define FLAG_HIDE_CERULEAN_ROCKET (0xA40 + 0x3B)
#undef FLAG_HIDE_CERULEAN_RIVAL
#define FLAG_HIDE_CERULEAN_RIVAL (0xA40 + 0x3C)
#undef FLAG_HIDE_SS_ANNE_RIVAL
#define FLAG_HIDE_SS_ANNE_RIVAL (0xA40 + 0x3D)
#undef FLAG_HIDE_SAFFRON_ROCKETS
#define FLAG_HIDE_SAFFRON_ROCKETS (0xA40 + 0x3E)
#undef FLAG_HIDE_SAFFRON_CIVILIANS
#define FLAG_HIDE_SAFFRON_CIVILIANS (0xA40 + 0x3F)
#undef FLAG_HIDE_SEAFOAM_1F_BOULDER_1
#define FLAG_HIDE_SEAFOAM_1F_BOULDER_1 (0xA40 + 0x40)
#undef FLAG_HIDE_SEAFOAM_1F_BOULDER_2
#define FLAG_HIDE_SEAFOAM_1F_BOULDER_2 (0xA40 + 0x41)
#undef FLAG_HIDE_SEAFOAM_B1F_BOULDER_1
#define FLAG_HIDE_SEAFOAM_B1F_BOULDER_1 (0xA40 + 0x42)
#undef FLAG_HIDE_SEAFOAM_B1F_BOULDER_2
#define FLAG_HIDE_SEAFOAM_B1F_BOULDER_2 (0xA40 + 0x43)
#undef FLAG_HIDE_SEAFOAM_B2F_BOULDER_1
#define FLAG_HIDE_SEAFOAM_B2F_BOULDER_1 (0xA40 + 0x44)
#undef FLAG_HIDE_SEAFOAM_B2F_BOULDER_2
#define FLAG_HIDE_SEAFOAM_B2F_BOULDER_2 (0xA40 + 0x45)
#undef FLAG_HIDE_SEAFOAM_B3F_BOULDER_1
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_1 (0xA40 + 0x46)
#undef FLAG_HIDE_SEAFOAM_B3F_BOULDER_2
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_2 (0xA40 + 0x47)
#undef FLAG_HIDE_SEAFOAM_B3F_BOULDER_3
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_3 (0xA40 + 0x48)
#undef FLAG_HIDE_SEAFOAM_B3F_BOULDER_4
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_4 (0xA40 + 0x49)
#undef FLAG_HIDE_SEAFOAM_B3F_BOULDER_5
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_5 (0xA40 + 0x4A)
#undef FLAG_HIDE_SEAFOAM_B3F_BOULDER_6
#define FLAG_HIDE_SEAFOAM_B3F_BOULDER_6 (0xA40 + 0x4B)
#undef FLAG_HIDE_SEAFOAM_B4F_BOULDER_1
#define FLAG_HIDE_SEAFOAM_B4F_BOULDER_1 (0xA40 + 0x4C)
#undef FLAG_HIDE_SEAFOAM_B4F_BOULDER_2
#define FLAG_HIDE_SEAFOAM_B4F_BOULDER_2 (0xA40 + 0x4D)
#undef FLAG_HIDE_SILPH_RIVAL
#define FLAG_HIDE_SILPH_RIVAL (0xA40 + 0x4E)
#undef FLAG_HIDE_ROUTE_22_RIVAL
#define FLAG_HIDE_ROUTE_22_RIVAL (0xA40 + 0x4F)
#undef FLAG_HIDE_PEWTER_MUSEUM_GUIDE
#define FLAG_HIDE_PEWTER_MUSEUM_GUIDE (0xA40 + 0x50)
#undef FLAG_HIDE_TOWER_RIVAL
#define FLAG_HIDE_TOWER_RIVAL (0xA40 + 0x51)
#undef FLAG_HIDE_MOLTRES
#define FLAG_HIDE_MOLTRES (0xA40 + 0x52)
#undef FLAG_HIDE_SILPH_ROCKETS
#define FLAG_HIDE_SILPH_ROCKETS (0xA40 + 0x53)
#undef FLAG_HIDE_ROUTE_12_SNORLAX
#define FLAG_HIDE_ROUTE_12_SNORLAX (0xA40 + 0x54)
#undef FLAG_HIDE_VIRIDIAN_GIOVANNI
#define FLAG_HIDE_VIRIDIAN_GIOVANNI (0xA40 + 0x55)
#undef FLAG_HIDE_OLD_AMBER
#define FLAG_HIDE_OLD_AMBER (0xA40 + 0x56)
#undef FLAG_HIDE_EEVEE_BALL
#define FLAG_HIDE_EEVEE_BALL (0xA40 + 0x57)
#undef FLAG_HIDE_VICTORY_ROAD_2F_BOULDER
#define FLAG_HIDE_VICTORY_ROAD_2F_BOULDER (0xA40 + 0x58)
#undef FLAG_HIDE_VICTORY_ROAD_3F_BOULDER
#define FLAG_HIDE_VICTORY_ROAD_3F_BOULDER (0xA40 + 0x59)
#undef FLAG_HIDE_OAK_IN_CHAMP_ROOM
#define FLAG_HIDE_OAK_IN_CHAMP_ROOM (0xA40 + 0x5A)
#undef FLAG_HIDE_GAME_CORNER_ROCKET
#define FLAG_HIDE_GAME_CORNER_ROCKET (0xA40 + 0x5B)
#undef FLAG_HIDE_CERULEAN_CAVE_GUARD
#define FLAG_HIDE_CERULEAN_CAVE_GUARD (0xA40 + 0x5C)
#undef FLAG_HIDE_ZAPDOS
#define FLAG_HIDE_ZAPDOS (0xA40 + 0x5D)
#undef FLAG_HIDE_TOWER_ROCKET_1
#define FLAG_HIDE_TOWER_ROCKET_1 (0xA40 + 0x5E)
#undef FLAG_HIDE_CELADON_ROCKETS
#define FLAG_HIDE_CELADON_ROCKETS (0xA40 + 0x5F)
#undef FLAG_HIDE_DOJO_HITMONLEE_BALL
#define FLAG_HIDE_DOJO_HITMONLEE_BALL (0xA40 + 0x60)
#undef FLAG_HIDE_DOJO_HITMONCHAN_BALL
#define FLAG_HIDE_DOJO_HITMONCHAN_BALL (0xA40 + 0x61)
#undef FLAG_HIDE_CINNABAR_BILL
#define FLAG_HIDE_CINNABAR_BILL (0xA40 + 0x62)
#undef FLAG_HIDE_UNION_ROOM_PLAYER_1
#define FLAG_HIDE_UNION_ROOM_PLAYER_1 (0xA40 + 0x63)
#undef FLAG_HIDE_UNION_ROOM_PLAYER_2
#define FLAG_HIDE_UNION_ROOM_PLAYER_2 (0xA40 + 0x64)
#undef FLAG_HIDE_UNION_ROOM_PLAYER_3
#define FLAG_HIDE_UNION_ROOM_PLAYER_3 (0xA40 + 0x65)
#undef FLAG_HIDE_UNION_ROOM_PLAYER_4
#define FLAG_HIDE_UNION_ROOM_PLAYER_4 (0xA40 + 0x66)
#undef FLAG_HIDE_UNION_ROOM_PLAYER_5
#define FLAG_HIDE_UNION_ROOM_PLAYER_5 (0xA40 + 0x67)
#undef FLAG_HIDE_UNION_ROOM_PLAYER_6
#define FLAG_HIDE_UNION_ROOM_PLAYER_6 (0xA40 + 0x68)
#undef FLAG_HIDE_UNION_ROOM_PLAYER_7
#define FLAG_HIDE_UNION_ROOM_PLAYER_7 (0xA40 + 0x69)
#undef FLAG_HIDE_UNION_ROOM_PLAYER_8
#define FLAG_HIDE_UNION_ROOM_PLAYER_8 (0xA40 + 0x6A)
#undef FLAG_HIDE_CINNABAR_SEAGALLOP
#define FLAG_HIDE_CINNABAR_SEAGALLOP (0xA40 + 0x6B)
#undef FLAG_HIDE_SAFFRON_FAN_CLUB_BLACKBELT
#define FLAG_HIDE_SAFFRON_FAN_CLUB_BLACKBELT (0xA40 + 0x6C)
#undef FLAG_HIDE_SAFFRON_FAN_CLUB_ROCKER
#define FLAG_HIDE_SAFFRON_FAN_CLUB_ROCKER (0xA40 + 0x6D)
#undef FLAG_HIDE_SAFFRON_FAN_CLUB_WOMAN
#define FLAG_HIDE_SAFFRON_FAN_CLUB_WOMAN (0xA40 + 0x6E)
#undef FLAG_HIDE_SAFFRON_FAN_CLUB_BEAUTY
#define FLAG_HIDE_SAFFRON_FAN_CLUB_BEAUTY (0xA40 + 0x6F)
#undef FLAG_HIDE_MG_DELIVERYMEN
#define FLAG_HIDE_MG_DELIVERYMEN (0xA40 + 0x70)
#undef FLAG_HIDE_ONE_ISLAND_BILL
#define FLAG_HIDE_ONE_ISLAND_BILL (0xA40 + 0x71)
#undef FLAG_HIDE_ONE_ISLAND_POKECENTER_BILL
#define FLAG_HIDE_ONE_ISLAND_POKECENTER_BILL (0xA40 + 0x72)
#undef FLAG_HIDE_ONE_ISLAND_POKECENTER_CELIO
#define FLAG_HIDE_ONE_ISLAND_POKECENTER_CELIO (0xA40 + 0x73)
#undef FLAG_HIDE_TWO_ISLAND_GAME_CORNER_BIKER
#define FLAG_HIDE_TWO_ISLAND_GAME_CORNER_BIKER (0xA40 + 0x74)
#undef FLAG_HIDE_TWO_ISLAND_GAME_CORNER_LOSTELLE
#define FLAG_HIDE_TWO_ISLAND_GAME_CORNER_LOSTELLE (0xA40 + 0x75)
#undef FLAG_HIDE_LOSTELLE_IN_HER_HOME
#define FLAG_HIDE_LOSTELLE_IN_HER_HOME (0xA40 + 0x76)
#undef FLAG_HIDE_THREE_ISLAND_BIKERS
#define FLAG_HIDE_THREE_ISLAND_BIKERS (0xA40 + 0x79)
#undef FLAG_HIDE_LOSTELLE_IN_BERRY_FOREST
#define FLAG_HIDE_LOSTELLE_IN_BERRY_FOREST (0xA40 + 0x7A)
#undef FLAG_HIDE_TWO_ISLAND_WOMAN
#define FLAG_HIDE_TWO_ISLAND_WOMAN (0xA40 + 0x7B)
#undef FLAG_HIDE_TWO_ISLAND_BEAUTY
#define FLAG_HIDE_TWO_ISLAND_BEAUTY (0xA40 + 0x7C)
#undef FLAG_HIDE_TWO_ISLAND_SUPER_NERD
#define FLAG_HIDE_TWO_ISLAND_SUPER_NERD (0xA40 + 0x7D)
#undef FLAG_HIDE_THREE_ISLAND_ANTIBIKERS
#define FLAG_HIDE_THREE_ISLAND_ANTIBIKERS (0xA40 + 0x7E)
#undef FLAG_HIDE_ROUTE_16_SNORLAX
#define FLAG_HIDE_ROUTE_16_SNORLAX (0xA40 + 0x80)
#undef FLAG_HIDE_MEWTWO
#define FLAG_HIDE_MEWTWO (0xA40 + 0x81)
#undef FLAG_HIDE_ARTICUNO
#define FLAG_HIDE_ARTICUNO (0xA40 + 0x82)
#undef FLAG_HIDE_TOWER_ROCKET_2
#define FLAG_HIDE_TOWER_ROCKET_2 (0xA40 + 0x83)
#undef FLAG_HIDE_TOWER_ROCKET_3
#define FLAG_HIDE_TOWER_ROCKET_3 (0xA40 + 0x84)
#undef FLAG_HIDE_POWER_PLANT_ELECTRODE_1
#define FLAG_HIDE_POWER_PLANT_ELECTRODE_1 (0xA40 + 0x85)
#undef FLAG_HIDE_POWER_PLANT_ELECTRODE_2
#define FLAG_HIDE_POWER_PLANT_ELECTRODE_2 (0xA40 + 0x86)
#undef FLAG_HIDE_SS_ANNE
#define FLAG_HIDE_SS_ANNE (0xA40 + 0x87)
#undef FLAG_HIDE_FIVE_ISLAND_ROCKETS
#define FLAG_HIDE_FIVE_ISLAND_ROCKETS (0xA40 + 0x88)
#undef FLAG_HIDE_MT_EMBER_EXTERIOR_ROCKETS
#define FLAG_HIDE_MT_EMBER_EXTERIOR_ROCKETS (0xA40 + 0x89)
#undef FLAG_HIDE_RUBY
#define FLAG_HIDE_RUBY (0xA40 + 0x8A)
#undef FLAG_HIDE_ICEFALL_CAVE_LORELEI
#define FLAG_HIDE_ICEFALL_CAVE_LORELEI (0xA40 + 0x8B)
#undef FLAG_HIDE_LORELEI_IN_HER_HOUSE
#define FLAG_HIDE_LORELEI_IN_HER_HOUSE (0xA40 + 0x8C)
#undef FLAG_HIDE_ICEFALL_CAVE_ROCKETS
#define FLAG_HIDE_ICEFALL_CAVE_ROCKETS (0xA40 + 0x8D)
#undef FLAG_HIDE_RUIN_VALLEY_SCIENTIST
#define FLAG_HIDE_RUIN_VALLEY_SCIENTIST (0xA40 + 0x8E)
#undef FLAG_HIDE_SAPPHIRE
#define FLAG_HIDE_SAPPHIRE (0xA40 + 0x8F)
#undef FLAG_HIDE_DOTTED_HOLE_SCIENTIST
#define FLAG_HIDE_DOTTED_HOLE_SCIENTIST (0xA40 + 0x90)
#undef FLAG_HIDE_THREE_ISLAND_LONE_BIKER
#define FLAG_HIDE_THREE_ISLAND_LONE_BIKER (0xA40 + 0x91)
#undef FLAG_HIDE_PEWTER_CITY_RUNNING_SHOES_GUY
#define FLAG_HIDE_PEWTER_CITY_RUNNING_SHOES_GUY (0xA40 + 0x92)
#undef FLAG_HIDE_LOST_CAVE_SELPHY
#define FLAG_HIDE_LOST_CAVE_SELPHY (0xA40 + 0x93)
#undef FLAG_HIDE_RESORT_GORGEOUS_SELPHY
#define FLAG_HIDE_RESORT_GORGEOUS_SELPHY (0xA40 + 0x94)
#undef FLAG_HIDE_RESORT_GORGEOUS_INSIDE_SELPHY
#define FLAG_HIDE_RESORT_GORGEOUS_INSIDE_SELPHY (0xA40 + 0x95)
#undef FLAG_HIDE_SELPHYS_BUTLER
#define FLAG_HIDE_SELPHYS_BUTLER (0xA40 + 0x96)
#undef FLAG_HIDE_FOUR_ISLAND_RIVAL
#define FLAG_HIDE_FOUR_ISLAND_RIVAL (0xA40 + 0x97)
#undef FLAG_HIDE_SIX_ISLAND_POKECENTER_RIVAL
#define FLAG_HIDE_SIX_ISLAND_POKECENTER_RIVAL (0xA40 + 0x98)
#undef FLAG_HIDE_BIRTH_ISLAND_METEORITE
#define FLAG_HIDE_BIRTH_ISLAND_METEORITE (0xA40 + 0x9A)
#undef FLAG_HIDE_POSTGAME_GOSSIPERS
#define FLAG_HIDE_POSTGAME_GOSSIPERS (0xA40 + 0x9D)
#undef FLAG_HIDE_FAME_CHECKER_ERIKA_JOURNALS
#define FLAG_HIDE_FAME_CHECKER_ERIKA_JOURNALS (0xA40 + 0x9E)
#undef FLAG_HIDE_FAME_CHECKER_KOGA_JOURNAL
#define FLAG_HIDE_FAME_CHECKER_KOGA_JOURNAL (0xA40 + 0x9F)
#undef FLAG_HIDE_FAME_CHECKER_LT_SURGE_JOURNAL
#define FLAG_HIDE_FAME_CHECKER_LT_SURGE_JOURNAL (0xA40 + 0xA0)
#undef FLAG_HIDE_VERMILION_CITY_OAKS_AIDE
#define FLAG_HIDE_VERMILION_CITY_OAKS_AIDE (0xA40 + 0xA1)
#undef FLAG_HIDE_CINNABAR_POKECENTER_BILL
#define FLAG_HIDE_CINNABAR_POKECENTER_BILL (0xA40 + 0xA2)
#undef FLAG_HIDE_CREDITS_RIVAL
#define FLAG_HIDE_CREDITS_RIVAL (0xA40 + 0xA3)
#undef FLAG_HIDE_CREDITS_OAK
#define FLAG_HIDE_CREDITS_OAK (0xA40 + 0xA4)
#undef FLAG_HIDE_LORELEI_HOUSE_MEOWTH_DOLL
#define FLAG_HIDE_LORELEI_HOUSE_MEOWTH_DOLL (0xA40 + 0xA5)
#undef FLAG_HIDE_LORELEI_HOUSE_CHANSEY_DOLL
#define FLAG_HIDE_LORELEI_HOUSE_CHANSEY_DOLL (0xA40 + 0xA6)
#undef FLAG_HIDE_LORELEIS_HOUSE_NIDORAN_F_DOLL
#define FLAG_HIDE_LORELEIS_HOUSE_NIDORAN_F_DOLL (0xA40 + 0xA7)
#undef FLAG_HIDE_LORELEI_HOUSE_JIGGLYPUFF_DOLL
#define FLAG_HIDE_LORELEI_HOUSE_JIGGLYPUFF_DOLL (0xA40 + 0xA8)
#undef FLAG_HIDE_LORELEIS_HOUSE_NIDORAN_M_DOLL
#define FLAG_HIDE_LORELEIS_HOUSE_NIDORAN_M_DOLL (0xA40 + 0xA9)
#undef FLAG_HIDE_LORELEIS_HOUSE_FEAROW_DOLL
#define FLAG_HIDE_LORELEIS_HOUSE_FEAROW_DOLL (0xA40 + 0xAA)
#undef FLAG_HIDE_LORELEIS_HOUSE_PIDGEOT_DOLL
#define FLAG_HIDE_LORELEIS_HOUSE_PIDGEOT_DOLL (0xA40 + 0xAB)
#undef FLAG_HIDE_LORELEIS_HOUSE_LAPRAS_DOLL
#define FLAG_HIDE_LORELEIS_HOUSE_LAPRAS_DOLL (0xA40 + 0xAC)
#undef FLAG_HIDE_MISC_KANTO_ROCKETS
#define FLAG_HIDE_MISC_KANTO_ROCKETS (0xA40 + 0xAD)
#undef FLAG_HIDE_SAFFRON_CITY_POKECENTER_SABRINA_JOURNALS
#define FLAG_HIDE_SAFFRON_CITY_POKECENTER_SABRINA_JOURNALS (0xA40 + 0xAE)
#undef FLAG_HIDE_ROUTE2_ETHER
#define FLAG_HIDE_ROUTE2_ETHER (0xA40 + 0x154)
#undef FLAG_HIDE_ROUTE2_PARALYZE_HEAL
#define FLAG_HIDE_ROUTE2_PARALYZE_HEAL (0xA40 + 0x155)
#undef FLAG_HIDE_VIRIDIAN_FOREST_POKE_BALL
#define FLAG_HIDE_VIRIDIAN_FOREST_POKE_BALL (0xA40 + 0x156)
#undef FLAG_HIDE_VIRIDIAN_FOREST_ANTIDOTE
#define FLAG_HIDE_VIRIDIAN_FOREST_ANTIDOTE (0xA40 + 0x157)
#undef FLAG_HIDE_VIRIDIAN_FOREST_POTION
#define FLAG_HIDE_VIRIDIAN_FOREST_POTION (0xA40 + 0x158)
#undef FLAG_HIDE_MT_MOON_1F_PARALYZE_HEAL
#define FLAG_HIDE_MT_MOON_1F_PARALYZE_HEAL (0xA40 + 0x159)
#undef FLAG_HIDE_MT_MOON_1F_TM09
#define FLAG_HIDE_MT_MOON_1F_TM09 (0xA40 + 0x15A)
#undef FLAG_HIDE_MT_MOON_1F_POTION
#define FLAG_HIDE_MT_MOON_1F_POTION (0xA40 + 0x15B)
#undef FLAG_HIDE_MT_MOON_1F_RARE_CANDY
#define FLAG_HIDE_MT_MOON_1F_RARE_CANDY (0xA40 + 0x15C)
#undef FLAG_HIDE_MT_MOON_1F_ESCAPE_ROPE
#define FLAG_HIDE_MT_MOON_1F_ESCAPE_ROPE (0xA40 + 0x15D)
#undef FLAG_HIDE_MT_MOON_1F_MOON_STONE
#define FLAG_HIDE_MT_MOON_1F_MOON_STONE (0xA40 + 0x15E)
#undef FLAG_HIDE_MT_MOON_B2F_STAR_PIECE
#define FLAG_HIDE_MT_MOON_B2F_STAR_PIECE (0xA40 + 0x15F)
#undef FLAG_HIDE_MT_MOON_B2F_TM46
#define FLAG_HIDE_MT_MOON_B2F_TM46 (0xA40 + 0x160)
#undef FLAG_HIDE_ROUTE4_TM05
#define FLAG_HIDE_ROUTE4_TM05 (0xA40 + 0x161)
#undef FLAG_HIDE_ROUTE24_TM45
#define FLAG_HIDE_ROUTE24_TM45 (0xA40 + 0x162)
#undef FLAG_HIDE_ROUTE25_TM43
#define FLAG_HIDE_ROUTE25_TM43 (0xA40 + 0x163)
#undef FLAG_HIDE_SSANNE_1F_ROOM2_TM31
#define FLAG_HIDE_SSANNE_1F_ROOM2_TM31 (0xA40 + 0x164)
#undef FLAG_HIDE_SSANNE_2F_ROOM2_STARDUST
#define FLAG_HIDE_SSANNE_2F_ROOM2_STARDUST (0xA40 + 0x165)
#undef FLAG_HIDE_SSANNE_2F_ROOM4_X_ATTACK
#define FLAG_HIDE_SSANNE_2F_ROOM4_X_ATTACK (0xA40 + 0x166)
#undef FLAG_HIDE_SSANNE_B1F_ROOM2_TM44
#define FLAG_HIDE_SSANNE_B1F_ROOM2_TM44 (0xA40 + 0x167)
#undef FLAG_HIDE_SSANNE_B1F_ROOM3_ETHER
#define FLAG_HIDE_SSANNE_B1F_ROOM3_ETHER (0xA40 + 0x168)
#undef FLAG_HIDE_SSANNE_B1F_ROOM5_SUPER_POTION
#define FLAG_HIDE_SSANNE_B1F_ROOM5_SUPER_POTION (0xA40 + 0x169)
#undef FLAG_HIDE_SSANNE_KITCHEN_GREAT_BALL
#define FLAG_HIDE_SSANNE_KITCHEN_GREAT_BALL (0xA40 + 0x16A)
#undef FLAG_HIDE_ROUTE9_TM40
#define FLAG_HIDE_ROUTE9_TM40 (0xA40 + 0x16B)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B1F_ESCAPE_ROPE
#define FLAG_HIDE_ROCKET_HIDEOUT_B1F_ESCAPE_ROPE (0xA40 + 0x16C)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B1F_HYPER_POTION
#define FLAG_HIDE_ROCKET_HIDEOUT_B1F_HYPER_POTION (0xA40 + 0x16D)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B2F_X_SPEED
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_X_SPEED (0xA40 + 0x16E)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B2F_MOON_STONE
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_MOON_STONE (0xA40 + 0x16F)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B2F_TM12
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_TM12 (0xA40 + 0x170)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B2F_SUPER_POTION
#define FLAG_HIDE_ROCKET_HIDEOUT_B2F_SUPER_POTION (0xA40 + 0x171)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B3F_RARE_CANDY
#define FLAG_HIDE_ROCKET_HIDEOUT_B3F_RARE_CANDY (0xA40 + 0x172)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B3F_TM21
#define FLAG_HIDE_ROCKET_HIDEOUT_B3F_TM21 (0xA40 + 0x173)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B4F_TM49
#define FLAG_HIDE_ROCKET_HIDEOUT_B4F_TM49 (0xA40 + 0x174)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B4F_MAX_ETHER
#define FLAG_HIDE_ROCKET_HIDEOUT_B4F_MAX_ETHER (0xA40 + 0x175)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B4F_CALCIUM
#define FLAG_HIDE_ROCKET_HIDEOUT_B4F_CALCIUM (0xA40 + 0x176)
#undef FLAG_HIDE_POKEMON_TOWER_3F_ESCAPE_ROPE
#define FLAG_HIDE_POKEMON_TOWER_3F_ESCAPE_ROPE (0xA40 + 0x177)
#undef FLAG_HIDE_POKEMON_TOWER_4F_ELIXIR
#define FLAG_HIDE_POKEMON_TOWER_4F_ELIXIR (0xA40 + 0x178)
#undef FLAG_HIDE_POKEMON_TOWER_4F_AWAKENING
#define FLAG_HIDE_POKEMON_TOWER_4F_AWAKENING (0xA40 + 0x179)
#undef FLAG_HIDE_POKEMON_TOWER_4F_GREAT_BALL
#define FLAG_HIDE_POKEMON_TOWER_4F_GREAT_BALL (0xA40 + 0x17A)
#undef FLAG_HIDE_POKEMON_TOWER_5F_NUGGET
#define FLAG_HIDE_POKEMON_TOWER_5F_NUGGET (0xA40 + 0x17B)
#undef FLAG_HIDE_POKEMON_TOWER_6F_RARE_CANDY
#define FLAG_HIDE_POKEMON_TOWER_6F_RARE_CANDY (0xA40 + 0x17C)
#undef FLAG_HIDE_POKEMON_TOWER_6F_X_ACCURACY
#define FLAG_HIDE_POKEMON_TOWER_6F_X_ACCURACY (0xA40 + 0x17D)
#undef FLAG_HIDE_ROUTE12_TM48
#define FLAG_HIDE_ROUTE12_TM48 (0xA40 + 0x17E)
#undef FLAG_HIDE_ROUTE12_IRON
#define FLAG_HIDE_ROUTE12_IRON (0xA40 + 0x17F)
#undef FLAG_HIDE_ROUTE15_TM18
#define FLAG_HIDE_ROUTE15_TM18 (0xA40 + 0x180)
#undef FLAG_HIDE_SAFARI_ZONE_CENTER_NUGGET
#define FLAG_HIDE_SAFARI_ZONE_CENTER_NUGGET (0xA40 + 0x181)
#undef FLAG_HIDE_SAFARI_ZONE_EAST_MAX_POTION
#define FLAG_HIDE_SAFARI_ZONE_EAST_MAX_POTION (0xA40 + 0x182)
#undef FLAG_HIDE_SAFARI_ZONE_EAST_FULL_RESTORE
#define FLAG_HIDE_SAFARI_ZONE_EAST_FULL_RESTORE (0xA40 + 0x183)
#undef FLAG_HIDE_SAFARI_ZONE_EAST_TM11
#define FLAG_HIDE_SAFARI_ZONE_EAST_TM11 (0xA40 + 0x184)
#undef FLAG_HIDE_SAFARI_ZONE_EAST_LEAF_STONE
#define FLAG_HIDE_SAFARI_ZONE_EAST_LEAF_STONE (0xA40 + 0x185)
#undef FLAG_HIDE_SAFARI_ZONE_NORTH_PROTEIN
#define FLAG_HIDE_SAFARI_ZONE_NORTH_PROTEIN (0xA40 + 0x186)
#undef FLAG_HIDE_SAFARI_ZONE_NORTH_TM47
#define FLAG_HIDE_SAFARI_ZONE_NORTH_TM47 (0xA40 + 0x187)
#undef FLAG_HIDE_SAFARI_ZONE_WEST_TM32
#define FLAG_HIDE_SAFARI_ZONE_WEST_TM32 (0xA40 + 0x188)
#undef FLAG_HIDE_SAFARI_ZONE_WEST_GOLD_TEETH
#define FLAG_HIDE_SAFARI_ZONE_WEST_GOLD_TEETH (0xA40 + 0x189)
#undef FLAG_HIDE_SAFARI_ZONE_WEST_MAX_POTION
#define FLAG_HIDE_SAFARI_ZONE_WEST_MAX_POTION (0xA40 + 0x18A)
#undef FLAG_HIDE_SAFARI_ZONE_WEST_MAX_REVIVE
#define FLAG_HIDE_SAFARI_ZONE_WEST_MAX_REVIVE (0xA40 + 0x18B)
#undef FLAG_HIDE_SILPH_CO_3F_HYPER_POTION
#define FLAG_HIDE_SILPH_CO_3F_HYPER_POTION (0xA40 + 0x18C)
#undef FLAG_HIDE_SILPH_CO_4F_MAX_REVIVE
#define FLAG_HIDE_SILPH_CO_4F_MAX_REVIVE (0xA40 + 0x18D)
#undef FLAG_HIDE_SILPH_CO_4F_ESCAPE_ROPE
#define FLAG_HIDE_SILPH_CO_4F_ESCAPE_ROPE (0xA40 + 0x18E)
#undef FLAG_HIDE_SILPH_CO_4F_FULL_HEAL
#define FLAG_HIDE_SILPH_CO_4F_FULL_HEAL (0xA40 + 0x18F)
#undef FLAG_HIDE_SILPH_CO_5F_PROTEIN
#define FLAG_HIDE_SILPH_CO_5F_PROTEIN (0xA40 + 0x190)
#undef FLAG_HIDE_SILPH_CO_5F_TM01
#define FLAG_HIDE_SILPH_CO_5F_TM01 (0xA40 + 0x191)
#undef FLAG_HIDE_SILPH_CO_5F_CARD_KEY
#define FLAG_HIDE_SILPH_CO_5F_CARD_KEY (0xA40 + 0x192)
#undef FLAG_HIDE_SILPH_CO_6F_HP_UP
#define FLAG_HIDE_SILPH_CO_6F_HP_UP (0xA40 + 0x193)
#undef FLAG_HIDE_SILPH_CO_6F_X_SPECIAL
#define FLAG_HIDE_SILPH_CO_6F_X_SPECIAL (0xA40 + 0x194)
#undef FLAG_HIDE_SILPH_CO_7F_CALCIUM
#define FLAG_HIDE_SILPH_CO_7F_CALCIUM (0xA40 + 0x195)
#undef FLAG_HIDE_SILPH_CO_7F_TM08
#define FLAG_HIDE_SILPH_CO_7F_TM08 (0xA40 + 0x196)
#undef FLAG_HIDE_SILPH_CO_10F_CARBOS
#define FLAG_HIDE_SILPH_CO_10F_CARBOS (0xA40 + 0x197)
#undef FLAG_HIDE_SILPH_CO_10F_ULTRA_BALL
#define FLAG_HIDE_SILPH_CO_10F_ULTRA_BALL (0xA40 + 0x198)
#undef FLAG_HIDE_SILPH_CO_10F_RARE_CANDY
#define FLAG_HIDE_SILPH_CO_10F_RARE_CANDY (0xA40 + 0x199)
#undef FLAG_HIDE_POWER_PLANT_MAX_POTION
#define FLAG_HIDE_POWER_PLANT_MAX_POTION (0xA40 + 0x19A)
#undef FLAG_HIDE_POWER_PLANT_TM17
#define FLAG_HIDE_POWER_PLANT_TM17 (0xA40 + 0x19B)
#undef FLAG_HIDE_POWER_PLANT_TM25
#define FLAG_HIDE_POWER_PLANT_TM25 (0xA40 + 0x19C)
#undef FLAG_HIDE_POWER_PLANT_THUNDER_STONE
#define FLAG_HIDE_POWER_PLANT_THUNDER_STONE (0xA40 + 0x19D)
#undef FLAG_HIDE_POWER_PLANT_ELIXIR
#define FLAG_HIDE_POWER_PLANT_ELIXIR (0xA40 + 0x19E)
#undef FLAG_HIDE_POKEMON_MANSION_1F_CARBOS
#define FLAG_HIDE_POKEMON_MANSION_1F_CARBOS (0xA40 + 0x19F)
#undef FLAG_HIDE_POKEMON_MANSION_1F_ESCAPE_ROPE
#define FLAG_HIDE_POKEMON_MANSION_1F_ESCAPE_ROPE (0xA40 + 0x1A0)
#undef FLAG_HIDE_POKEMON_MANSION_2F_CALCIUM
#define FLAG_HIDE_POKEMON_MANSION_2F_CALCIUM (0xA40 + 0x1A1)
#undef FLAG_HIDE_POKEMON_MANSION_3F_MAX_POTION
#define FLAG_HIDE_POKEMON_MANSION_3F_MAX_POTION (0xA40 + 0x1A2)
#undef FLAG_HIDE_POKEMON_MANSION_3F_IRON
#define FLAG_HIDE_POKEMON_MANSION_3F_IRON (0xA40 + 0x1A3)
#undef FLAG_HIDE_POKEMON_MANSION_B1F_TM14
#define FLAG_HIDE_POKEMON_MANSION_B1F_TM14 (0xA40 + 0x1A4)
#undef FLAG_HIDE_POKEMON_MANSION_B1F_FULL_RESTORE
#define FLAG_HIDE_POKEMON_MANSION_B1F_FULL_RESTORE (0xA40 + 0x1A5)
#undef FLAG_HIDE_POKEMON_MANSION_B1F_TM22
#define FLAG_HIDE_POKEMON_MANSION_B1F_TM22 (0xA40 + 0x1A7)
#undef FLAG_HIDE_POKEMON_MANSION_B1F_SECRET_KEY
#define FLAG_HIDE_POKEMON_MANSION_B1F_SECRET_KEY (0xA40 + 0x1A8)
#undef FLAG_HIDE_VICTORY_ROAD_1F_RARE_CANDY
#define FLAG_HIDE_VICTORY_ROAD_1F_RARE_CANDY (0xA40 + 0x1A9)
#undef FLAG_HIDE_VICTORY_ROAD_1F_TM02
#define FLAG_HIDE_VICTORY_ROAD_1F_TM02 (0xA40 + 0x1AA)
#undef FLAG_HIDE_VICTORY_ROAD_2F_GUARD_SPEC
#define FLAG_HIDE_VICTORY_ROAD_2F_GUARD_SPEC (0xA40 + 0x1AB)
#undef FLAG_HIDE_VICTORY_ROAD_2F_TM07
#define FLAG_HIDE_VICTORY_ROAD_2F_TM07 (0xA40 + 0x1AC)
#undef FLAG_HIDE_VICTORY_ROAD_2F_FULL_HEAL
#define FLAG_HIDE_VICTORY_ROAD_2F_FULL_HEAL (0xA40 + 0x1AD)
#undef FLAG_HIDE_VICTORY_ROAD_2F_TM37
#define FLAG_HIDE_VICTORY_ROAD_2F_TM37 (0xA40 + 0x1AE)
#undef FLAG_HIDE_VICTORY_ROAD_3F_MAX_REVIVE
#define FLAG_HIDE_VICTORY_ROAD_3F_MAX_REVIVE (0xA40 + 0x1AF)
#undef FLAG_HIDE_VICTORY_ROAD_3F_TM50
#define FLAG_HIDE_VICTORY_ROAD_3F_TM50 (0xA40 + 0x1B0)
#undef FLAG_HIDE_CERULEAN_CAVE_1F_MAX_ELIXIR
#define FLAG_HIDE_CERULEAN_CAVE_1F_MAX_ELIXIR (0xA40 + 0x1B1)
#undef FLAG_HIDE_CERULEAN_CAVE_1F_NUGGET
#define FLAG_HIDE_CERULEAN_CAVE_1F_NUGGET (0xA40 + 0x1B2)
#undef FLAG_HIDE_CERULEAN_CAVE_1F_FULL_RESTORE
#define FLAG_HIDE_CERULEAN_CAVE_1F_FULL_RESTORE (0xA40 + 0x1B3)
#undef FLAG_HIDE_CERULEAN_CAVE_2F_FULL_RESTORE
#define FLAG_HIDE_CERULEAN_CAVE_2F_FULL_RESTORE (0xA40 + 0x1B4)
#undef FLAG_HIDE_CERULEAN_CAVE_2F_PP_UP
#define FLAG_HIDE_CERULEAN_CAVE_2F_PP_UP (0xA40 + 0x1B5)
#undef FLAG_HIDE_CERULEAN_CAVE_2F_ULTRA_BALL
#define FLAG_HIDE_CERULEAN_CAVE_2F_ULTRA_BALL (0xA40 + 0x1B6)
#undef FLAG_HIDE_CERULEAN_CAVE_B1F_MAX_REVIVE
#define FLAG_HIDE_CERULEAN_CAVE_B1F_MAX_REVIVE (0xA40 + 0x1B7)
#undef FLAG_HIDE_CERULEAN_CAVE_B1F_ULTRA_BALL
#define FLAG_HIDE_CERULEAN_CAVE_B1F_ULTRA_BALL (0xA40 + 0x1B8)
#undef FLAG_HIDE_FUCHSIA_CITY_WARDENS_HOUSE_RARE_CANDY
#define FLAG_HIDE_FUCHSIA_CITY_WARDENS_HOUSE_RARE_CANDY (0xA40 + 0x1B9)
#undef FLAG_HIDE_TWO_ISLAND_REVIVE
#define FLAG_HIDE_TWO_ISLAND_REVIVE (0xA40 + 0x1BA)
#undef FLAG_HIDE_THREE_ISLAND_ZINC
#define FLAG_HIDE_THREE_ISLAND_ZINC (0xA40 + 0x1BB)
#undef FLAG_HIDE_VIRIDIAN_FOREST_POTION_2
#define FLAG_HIDE_VIRIDIAN_FOREST_POTION_2 (0xA40 + 0x1BE)
#undef FLAG_HIDE_MT_MOON_B2F_REVIVE
#define FLAG_HIDE_MT_MOON_B2F_REVIVE (0xA40 + 0x1BF)
#undef FLAG_HIDE_MT_MOON_B2F_ANTIDOTE
#define FLAG_HIDE_MT_MOON_B2F_ANTIDOTE (0xA40 + 0x1C0)
#undef FLAG_HIDE_ROUTE11_X_DEFEND
#define FLAG_HIDE_ROUTE11_X_DEFEND (0xA40 + 0x1C1)
#undef FLAG_HIDE_ROUTE9_BURN_HEAL
#define FLAG_HIDE_ROUTE9_BURN_HEAL (0xA40 + 0x1C2)
#undef FLAG_HIDE_ROCK_TUNNEL_1F_REPEL
#define FLAG_HIDE_ROCK_TUNNEL_1F_REPEL (0xA40 + 0x1C3)
#undef FLAG_HIDE_ROCK_TUNNEL_1F_PEARL
#define FLAG_HIDE_ROCK_TUNNEL_1F_PEARL (0xA40 + 0x1C4)
#undef FLAG_HIDE_ROCK_TUNNEL_1F_ESCAPE_ROPE
#define FLAG_HIDE_ROCK_TUNNEL_1F_ESCAPE_ROPE (0xA40 + 0x1C5)
#undef FLAG_HIDE_ROCK_TUNNEL_B1F_REVIVE
#define FLAG_HIDE_ROCK_TUNNEL_B1F_REVIVE (0xA40 + 0x1C6)
#undef FLAG_HIDE_ROCK_TUNNEL_B1F_MAX_ETHER
#define FLAG_HIDE_ROCK_TUNNEL_B1F_MAX_ETHER (0xA40 + 0x1C7)
#undef FLAG_HIDE_SILPH_CO_8F_IRON
#define FLAG_HIDE_SILPH_CO_8F_IRON (0xA40 + 0x1C8)
#undef FLAG_HIDE_SILPH_CO_11F_ZINC
#define FLAG_HIDE_SILPH_CO_11F_ZINC (0xA40 + 0x1C9)
#undef FLAG_HIDE_POKEMON_MANSION_1F_PROTEIN
#define FLAG_HIDE_POKEMON_MANSION_1F_PROTEIN (0xA40 + 0x1CA)
#undef FLAG_HIDE_POKEMON_MANSION_2F_ZINC
#define FLAG_HIDE_POKEMON_MANSION_2F_ZINC (0xA40 + 0x1CB)
#undef FLAG_HIDE_POKEMON_MANSION_2F_HP_UP
#define FLAG_HIDE_POKEMON_MANSION_2F_HP_UP (0xA40 + 0x1CC)
#undef FLAG_HIDE_VIRIDIAN_CITY_POTION
#define FLAG_HIDE_VIRIDIAN_CITY_POTION (0xA40 + 0x1CD)
#undef FLAG_HIDE_ROUTE11_GREAT_BALL
#define FLAG_HIDE_ROUTE11_GREAT_BALL (0xA40 + 0x1CE)
#undef FLAG_HIDE_ROUTE11_AWAKENING
#define FLAG_HIDE_ROUTE11_AWAKENING (0xA40 + 0x1CF)
#undef FLAG_HIDE_POKEMON_TOWER_5F_CLEANSE_TAG
#define FLAG_HIDE_POKEMON_TOWER_5F_CLEANSE_TAG (0xA40 + 0x1D0)
#undef FLAG_HIDE_CELADON_CITY_ETHER
#define FLAG_HIDE_CELADON_CITY_ETHER (0xA40 + 0x1D1)
#undef FLAG_HIDE_ROCKET_HIDEOUT_B3F_BLACK_GLASSES
#define FLAG_HIDE_ROCKET_HIDEOUT_B3F_BLACK_GLASSES (0xA40 + 0x1D2)
#undef FLAG_HIDE_SAFARI_ZONE_NORTH_QUICK_CLAW
#define FLAG_HIDE_SAFARI_ZONE_NORTH_QUICK_CLAW (0xA40 + 0x1D3)
#undef FLAG_HIDE_SEAFOAM_ISLANDS_1F_ICE_HEAL
#define FLAG_HIDE_SEAFOAM_ISLANDS_1F_ICE_HEAL (0xA40 + 0x1D4)
#undef FLAG_HIDE_SEAFOAM_ISLANDS_B1F_WATER_STONE
#define FLAG_HIDE_SEAFOAM_ISLANDS_B1F_WATER_STONE (0xA40 + 0x1D5)
#undef FLAG_HIDE_SEAFOAM_ISLANDS_B1F_REVIVE
#define FLAG_HIDE_SEAFOAM_ISLANDS_B1F_REVIVE (0xA40 + 0x1D6)
#undef FLAG_HIDE_SEAFOAM_ISLANDS_B2F_BIG_PEARL
#define FLAG_HIDE_SEAFOAM_ISLANDS_B2F_BIG_PEARL (0xA40 + 0x1D7)
#undef FLAG_HIDE_SEAFOAM_ISLANDS_B4F_ULTRA_BALL
#define FLAG_HIDE_SEAFOAM_ISLANDS_B4F_ULTRA_BALL (0xA40 + 0x1D8)
#undef FLAG_HIDE_FOUR_ISLAND_STAR_PIECE
#define FLAG_HIDE_FOUR_ISLAND_STAR_PIECE (0xA40 + 0x1D9)
#undef FLAG_HIDE_FOUR_ISLAND_STARDUST
#define FLAG_HIDE_FOUR_ISLAND_STARDUST (0xA40 + 0x1DA)
#undef FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_ETHER
#define FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_ETHER (0xA40 + 0x1DB)
#undef FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_MAX_REPEL
#define FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_MAX_REPEL (0xA40 + 0x1DC)
#undef FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_CARBOS
#define FLAG_HIDE_ONE_ISLAND_KINDLE_ROAD_CARBOS (0xA40 + 0x1DD)
#undef FLAG_HIDE_FIVE_ISLAND_MEADOW_MAX_POTION
#define FLAG_HIDE_FIVE_ISLAND_MEADOW_MAX_POTION (0xA40 + 0x1DE)
#undef FLAG_HIDE_FIVE_ISLAND_MEADOW_PP_UP
#define FLAG_HIDE_FIVE_ISLAND_MEADOW_PP_UP (0xA40 + 0x1DF)
#undef FLAG_HIDE_FIVE_ISLAND_MEMORIAL_PILLAR_METAL_COAT
#define FLAG_HIDE_FIVE_ISLAND_MEMORIAL_PILLAR_METAL_COAT (0xA40 + 0x1E0)
#undef FLAG_HIDE_SIX_ISLAND_OUTCAST_ISLAND_PP_UP
#define FLAG_HIDE_SIX_ISLAND_OUTCAST_ISLAND_PP_UP (0xA40 + 0x1E1)
#undef FLAG_HIDE_SIX_ISLAND_WATER_PATH_ELIXIR
#define FLAG_HIDE_SIX_ISLAND_WATER_PATH_ELIXIR (0xA40 + 0x1E2)
#undef FLAG_HIDE_SIX_ISLAND_WATER_PATH_DRAGON_SCALE
#define FLAG_HIDE_SIX_ISLAND_WATER_PATH_DRAGON_SCALE (0xA40 + 0x1E3)
#undef FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_FULL_RESTORE
#define FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_FULL_RESTORE (0xA40 + 0x1E4)
#undef FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_HP_UP
#define FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_HP_UP (0xA40 + 0x1E5)
#undef FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_SUN_STONE
#define FLAG_HIDE_SIX_ISLAND_RUIN_VALLEY_SUN_STONE (0xA40 + 0x1E6)
#undef FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_KINGS_ROCK
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_KINGS_ROCK (0xA40 + 0x1E7)
#undef FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_MAX_ELIXIR
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_MAX_ELIXIR (0xA40 + 0x1E8)
#undef FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_NUGGET
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_NUGGET (0xA40 + 0x1E9)
#undef FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_MAX_ETHER
#define FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_MAX_ETHER (0xA40 + 0x1EA)
#undef FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_FULL_HEAL
#define FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_FULL_HEAL (0xA40 + 0x1EB)
#undef FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_MAX_ELIXIR
#define FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_MAX_ELIXIR (0xA40 + 0x1EC)
#undef FLAG_HIDE_MT_EMBER_EXTERIOR_ULTRA_BALL
#define FLAG_HIDE_MT_EMBER_EXTERIOR_ULTRA_BALL (0xA40 + 0x1ED)
#undef FLAG_HIDE_MT_EMBER_EXTERIOR_FIRE_STONE
#define FLAG_HIDE_MT_EMBER_EXTERIOR_FIRE_STONE (0xA40 + 0x1EE)
#undef FLAG_HIDE_MT_EMBER_EXTERIOR_DIRE_HIT
#define FLAG_HIDE_MT_EMBER_EXTERIOR_DIRE_HIT (0xA40 + 0x1EF)
#undef FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_1F_ULTRA_BALL
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_1F_ULTRA_BALL (0xA40 + 0x1F0)
#undef FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_1F_HM07
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_1F_HM07 (0xA40 + 0x1F1)
#undef FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_B1F_FULL_RESTORE
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_B1F_FULL_RESTORE (0xA40 + 0x1F2)
#undef FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_B1F_NEVER_MELT_ICE
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_B1F_NEVER_MELT_ICE (0xA40 + 0x1F3)
#undef FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_BIG_PEARL
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_BIG_PEARL (0xA40 + 0x1F4)
#undef FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_TM36
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_TM36 (0xA40 + 0x1F5)
#undef FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_PEARL
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_PEARL (0xA40 + 0x1F6)
#undef FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_UP_GRADE
#define FLAG_HIDE_FIVE_ISLAND_ROCKET_WAREHOUSE_UP_GRADE (0xA40 + 0x1F7)
#undef FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM10_SILK_SCARF
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM10_SILK_SCARF (0xA40 + 0x1F8)
#undef FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM11_LAX_INCENSE
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM11_LAX_INCENSE (0xA40 + 0x1F9)
#undef FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM12_SEA_INCENSE
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM12_SEA_INCENSE (0xA40 + 0x1FA)
#undef FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM13_MAX_REVIVE
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM13_MAX_REVIVE (0xA40 + 0x1FB)
#undef FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM14_RARE_CANDY
#define FLAG_HIDE_FIVE_ISLAND_LOST_CAVE_ROOM14_RARE_CANDY (0xA40 + 0x1FC)
#undef FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_HOUSE_LUCKY_PUNCH
#define FLAG_HIDE_SEVEN_ISLAND_SEVAULT_CANYON_HOUSE_LUCKY_PUNCH (0xA40 + 0x1FD)
#undef FLAG_HIDE_SILPH_CO_4F_TM41
#define FLAG_HIDE_SILPH_CO_4F_TM41 (0xA40 + 0x1FE)
#undef FLAG_GOT_POTION_ON_ROUTE_1
#define FLAG_GOT_POTION_ON_ROUTE_1 (0xA40 + 0x230)
#undef FLAG_GOT_TM34_FROM_SURGE
#define FLAG_GOT_TM34_FROM_SURGE (0xA40 + 0x231)
#undef FLAG_GOT_FOSSIL_FROM_MT_MOON
#define FLAG_GOT_FOSSIL_FROM_MT_MOON (0xA40 + 0x232)
#undef FLAG_HELPED_BILL_IN_SEA_COTTAGE
#define FLAG_HELPED_BILL_IN_SEA_COTTAGE (0xA40 + 0x233)
#undef FLAG_GOT_SS_TICKET
#define FLAG_GOT_SS_TICKET (0xA40 + 0x234)
#undef FLAG_GOT_SS_TICKET_DUP
#define FLAG_GOT_SS_TICKET_DUP (0xA40 + 0x235)
#undef FLAG_GOT_TM42_AT_MEMORIAL_PILLAR
#define FLAG_GOT_TM42_AT_MEMORIAL_PILLAR (0xA40 + 0x236)
#undef FLAG_GOT_HM01
#define FLAG_GOT_HM01 (0xA40 + 0x237)
#undef FLAG_GOT_HM02
#define FLAG_GOT_HM02 (0xA40 + 0x238)
#undef FLAG_GOT_HM03
#define FLAG_GOT_HM03 (0xA40 + 0x239)
#undef FLAG_GOT_HM04
#define FLAG_GOT_HM04 (0xA40 + 0x23A)
#undef FLAG_GOT_HM05
#define FLAG_GOT_HM05 (0xA40 + 0x23B)
#undef FLAG_RESCUED_MR_FUJI
#define FLAG_RESCUED_MR_FUJI (0xA40 + 0x23C)
#undef FLAG_GOT_POKE_FLUTE
#define FLAG_GOT_POKE_FLUTE (0xA40 + 0x23D)
#undef FLAG_GOT_TM28_FROM_ROCKET
#define FLAG_GOT_TM28_FROM_ROCKET (0xA40 + 0x23F)
#undef FLAG_GOT_OLD_ROD
#define FLAG_GOT_OLD_ROD (0xA40 + 0x240)
#undef FLAG_GOT_BIKE_VOUCHER
#define FLAG_GOT_BIKE_VOUCHER (0xA40 + 0x241)
#undef FLAG_GOT_COIN_CASE
#define FLAG_GOT_COIN_CASE (0xA40 + 0x243)
#undef FLAG_GOT_GOOD_ROD
#define FLAG_GOT_GOOD_ROD (0xA40 + 0x244)
#undef FLAG_GOT_TM29_FROM_MR_PSYCHIC
#define FLAG_GOT_TM29_FROM_MR_PSYCHIC (0xA40 + 0x245)
#undef FLAG_GOT_LAPRAS_FROM_SILPH
#define FLAG_GOT_LAPRAS_FROM_SILPH (0xA40 + 0x246)
#undef FLAG_GOT_POKEBALLS_FROM_OAK_AFTER_22_RIVAL
#define FLAG_GOT_POKEBALLS_FROM_OAK_AFTER_22_RIVAL (0xA40 + 0x247)
#undef FLAG_DID_MIMIEN_TRADE
#define FLAG_DID_MIMIEN_TRADE (0xA40 + 0x248)
#undef FLAG_BOUGHT_MAGIKARP
#define FLAG_BOUGHT_MAGIKARP (0xA40 + 0x249)
#undef FLAG_DID_ZYNX_TRADE
#define FLAG_DID_ZYNX_TRADE (0xA40 + 0x24A)
#undef FLAG_DID_MS_NIDO_TRADE
#define FLAG_DID_MS_NIDO_TRADE (0xA40 + 0x24B)
#undef FLAG_DID_CH_DING_TRADE
#define FLAG_DID_CH_DING_TRADE (0xA40 + 0x24D)
#undef FLAG_GOT_TM38_FROM_BLAINE
#define FLAG_GOT_TM38_FROM_BLAINE (0xA40 + 0x24E)
#undef FLAG_OAK_SKIP_22_RIVAL_CHECK
#define FLAG_OAK_SKIP_22_RIVAL_CHECK (0xA40 + 0x24F)
#undef FLAG_GOT_MASTER_BALL_FROM_SILPH
#define FLAG_GOT_MASTER_BALL_FROM_SILPH (0xA40 + 0x250)
#undef FLAG_DID_NINA_TRADE
#define FLAG_DID_NINA_TRADE (0xA40 + 0x251)
#undef FLAG_GOT_ITEMFINDER
#define FLAG_GOT_ITEMFINDER (0xA40 + 0x252)
#undef FLAG_WOKE_UP_ROUTE_12_SNORLAX
#define FLAG_WOKE_UP_ROUTE_12_SNORLAX (0xA40 + 0x253)
#undef FLAG_GOT_TM39_FROM_BROCK
#define FLAG_GOT_TM39_FROM_BROCK (0xA40 + 0x254)
#undef FLAG_GOT_SUPER_ROD
#define FLAG_GOT_SUPER_ROD (0xA40 + 0x255)
#undef FLAG_GOT_EXP_SHARE_FROM_OAKS_AIDE
#define FLAG_GOT_EXP_SHARE_FROM_OAKS_AIDE (0xA40 + 0x256)
#undef FLAG_DID_MARC_TRADE
#define FLAG_DID_MARC_TRADE (0xA40 + 0x257)
#undef FLAG_BEAT_RIVAL_IN_OAKS_LAB
#define FLAG_BEAT_RIVAL_IN_OAKS_LAB (0xA40 + 0x258)
#undef FLAG_GOT_TM06_FROM_KOGA
#define FLAG_GOT_TM06_FROM_KOGA (0xA40 + 0x259)
#undef FLAG_GOT_TM27
#define FLAG_GOT_TM27 (0xA40 + 0x25B)
#undef FLAG_GOT_OLD_AMBER
#define FLAG_GOT_OLD_AMBER (0xA40 + 0x25E)
#undef FLAG_GOT_EEVEE
#define FLAG_GOT_EEVEE (0xA40 + 0x263)
#undef FLAG_FOUND_BOTH_VERMILION_GYM_SWITCHES
#define FLAG_FOUND_BOTH_VERMILION_GYM_SWITCHES (0xA40 + 0x264)
#undef FLAG_CINNABAR_GYM_QUIZ_1
#define FLAG_CINNABAR_GYM_QUIZ_1 (0xA40 + 0x265)
#undef FLAG_CINNABAR_GYM_QUIZ_2
#define FLAG_CINNABAR_GYM_QUIZ_2 (0xA40 + 0x267)
#undef FLAG_CINNABAR_GYM_QUIZ_3
#define FLAG_CINNABAR_GYM_QUIZ_3 (0xA40 + 0x268)
#undef FLAG_CINNABAR_GYM_QUIZ_4
#define FLAG_CINNABAR_GYM_QUIZ_4 (0xA40 + 0x269)
#undef FLAG_CINNABAR_GYM_QUIZ_5
#define FLAG_CINNABAR_GYM_QUIZ_5 (0xA40 + 0x26A)
#undef FLAG_CINNABAR_GYM_QUIZ_6
#define FLAG_CINNABAR_GYM_QUIZ_6 (0xA40 + 0x26B)
#undef FLAG_POKEMON_MANSION_SWITCH_STATE
#define FLAG_POKEMON_MANSION_SWITCH_STATE (0xA40 + 0x26C)
#undef FLAG_OPENED_ROCKET_HIDEOUT
#define FLAG_OPENED_ROCKET_HIDEOUT (0xA40 + 0x26D)
#undef FLAG_GOT_10_COINS_FROM_GAMBLER
#define FLAG_GOT_10_COINS_FROM_GAMBLER (0xA40 + 0x26E)
#undef FLAG_GOT_20_COINS_FROM_GAMBLER
#define FLAG_GOT_20_COINS_FROM_GAMBLER (0xA40 + 0x26F)
#undef FLAG_GOT_20_COINS_FROM_GAMBLER_2
#define FLAG_GOT_20_COINS_FROM_GAMBLER_2 (0xA40 + 0x270)
#undef FLAG_GOT_BICYCLE
#define FLAG_GOT_BICYCLE (0xA40 + 0x271)
#undef FLAG_GOT_DOME_FOSSIL
#define FLAG_GOT_DOME_FOSSIL (0xA40 + 0x272)
#undef FLAG_GOT_HELIX_FOSSIL
#define FLAG_GOT_HELIX_FOSSIL (0xA40 + 0x273)
#undef FLAG_DID_ESPHERE_TRADE
#define FLAG_DID_ESPHERE_TRADE (0xA40 + 0x274)
#undef FLAG_DID_TANGENY_TRADE
#define FLAG_DID_TANGENY_TRADE (0xA40 + 0x275)
#undef FLAG_DID_SEELOR_TRADE
#define FLAG_DID_SEELOR_TRADE (0xA40 + 0x276)
#undef FLAG_GOT_HITMON_FROM_DOJO
#define FLAG_GOT_HITMON_FROM_DOJO (0xA40 + 0x278)
#undef FLAG_SILPH_2F_DOOR_1
#define FLAG_SILPH_2F_DOOR_1 (0xA40 + 0x27A)
#undef FLAG_SILPH_2F_DOOR_2
#define FLAG_SILPH_2F_DOOR_2 (0xA40 + 0x27B)
#undef FLAG_SILPH_3F_DOOR_1
#define FLAG_SILPH_3F_DOOR_1 (0xA40 + 0x27C)
#undef FLAG_SILPH_3F_DOOR_2
#define FLAG_SILPH_3F_DOOR_2 (0xA40 + 0x27D)
#undef FLAG_SILPH_4F_DOOR_1
#define FLAG_SILPH_4F_DOOR_1 (0xA40 + 0x27E)
#undef FLAG_SILPH_4F_DOOR_2
#define FLAG_SILPH_4F_DOOR_2 (0xA40 + 0x27F)
#undef FLAG_SILPH_5F_DOOR_1
#define FLAG_SILPH_5F_DOOR_1 (0xA40 + 0x280)
#undef FLAG_SILPH_5F_DOOR_2
#define FLAG_SILPH_5F_DOOR_2 (0xA40 + 0x281)
#undef FLAG_SILPH_5F_DOOR_3
#define FLAG_SILPH_5F_DOOR_3 (0xA40 + 0x282)
#undef FLAG_SILPH_6F_DOOR
#define FLAG_SILPH_6F_DOOR (0xA40 + 0x283)
#undef FLAG_SILPH_7F_DOOR_1
#define FLAG_SILPH_7F_DOOR_1 (0xA40 + 0x284)
#undef FLAG_SILPH_7F_DOOR_2
#define FLAG_SILPH_7F_DOOR_2 (0xA40 + 0x285)
#undef FLAG_SILPH_7F_DOOR_3
#define FLAG_SILPH_7F_DOOR_3 (0xA40 + 0x286)
#undef FLAG_SILPH_8F_DOOR
#define FLAG_SILPH_8F_DOOR (0xA40 + 0x287)
#undef FLAG_SILPH_9F_DOOR_1
#define FLAG_SILPH_9F_DOOR_1 (0xA40 + 0x288)
#undef FLAG_SILPH_9F_DOOR_2
#define FLAG_SILPH_9F_DOOR_2 (0xA40 + 0x289)
#undef FLAG_SILPH_9F_DOOR_3
#define FLAG_SILPH_9F_DOOR_3 (0xA40 + 0x28A)
#undef FLAG_SILPH_9F_DOOR_4
#define FLAG_SILPH_9F_DOOR_4 (0xA40 + 0x28B)
#undef FLAG_SILPH_10F_DOOR
#define FLAG_SILPH_10F_DOOR (0xA40 + 0x28C)
#undef FLAG_SILPH_11F_DOOR
#define FLAG_SILPH_11F_DOOR (0xA40 + 0x28D)
#undef FLAG_MET_STICKER_MAN
#define FLAG_MET_STICKER_MAN (0xA40 + 0x290)
#undef FLAG_PALLET_LADY_NOT_BLOCKING_SIGN
#define FLAG_PALLET_LADY_NOT_BLOCKING_SIGN (0xA40 + 0x291)
#undef FLAG_GOT_VS_SEEKER
#define FLAG_GOT_VS_SEEKER (0xA40 + 0x292)
#undef FLAG_GOT_TM19_FROM_ERIKA
#define FLAG_GOT_TM19_FROM_ERIKA (0xA40 + 0x293)
#undef FLAG_GOT_TM33_FROM_THIRSTY_GIRL
#define FLAG_GOT_TM33_FROM_THIRSTY_GIRL (0xA40 + 0x294)
#undef FLAG_GOT_TM20_FROM_THIRSTY_GIRL
#define FLAG_GOT_TM20_FROM_THIRSTY_GIRL (0xA40 + 0x295)
#undef FLAG_GOT_TM16_FROM_THIRSTY_GIRL
#define FLAG_GOT_TM16_FROM_THIRSTY_GIRL (0xA40 + 0x296)
#undef FLAG_GOT_TM03_FROM_MISTY
#define FLAG_GOT_TM03_FROM_MISTY (0xA40 + 0x297)
#undef FLAG_GOT_TM26_FROM_GIOVANNI
#define FLAG_GOT_TM26_FROM_GIOVANNI (0xA40 + 0x298)
#undef FLAG_GOT_TM04_FROM_SABRINA
#define FLAG_GOT_TM04_FROM_SABRINA (0xA40 + 0x29A)
#undef FLAG_GOT_FAME_CHECKER
#define FLAG_GOT_FAME_CHECKER (0xA40 + 0x29B)
#undef FLAG_GOT_RECORD_SETTING_MAGIKARP
#define FLAG_GOT_RECORD_SETTING_MAGIKARP (0xA40 + 0x29C)
#undef FLAG_TWO_ISLAND_SHOP_INTRODUCED
#define FLAG_TWO_ISLAND_SHOP_INTRODUCED (0xA40 + 0x29D)
#undef FLAG_TWO_ISLAND_SHOP_EXPANDED_1
#define FLAG_TWO_ISLAND_SHOP_EXPANDED_1 (0xA40 + 0x29E)
#undef FLAG_TWO_ISLAND_SHOP_EXPANDED_2
#define FLAG_TWO_ISLAND_SHOP_EXPANDED_2 (0xA40 + 0x29F)
#undef FLAG_TWO_ISLAND_SHOP_EXPANDED_3
#define FLAG_TWO_ISLAND_SHOP_EXPANDED_3 (0xA40 + 0x2A0)
#undef FLAG_SEVII_DETOUR_FINISHED
#define FLAG_SEVII_DETOUR_FINISHED (0xA40 + 0x2A1)
#undef FLAG_VISITED_TWO_ISLAND
#define FLAG_VISITED_TWO_ISLAND (0xA40 + 0x2A2)
#undef FLAG_RESCUED_LOSTELLE
#define FLAG_RESCUED_LOSTELLE (0xA40 + 0x2A3)
#undef FLAG_CAN_USE_ROCKET_HIDEOUT_LIFT
#define FLAG_CAN_USE_ROCKET_HIDEOUT_LIFT (0xA40 + 0x2A5)
#undef FLAG_GOT_TEA
#define FLAG_GOT_TEA (0xA40 + 0x2A6)
#undef FLAG_GOT_POWDER_JAR
#define FLAG_GOT_POWDER_JAR (0xA40 + 0x2BB)
#undef FLAG_FOUGHT_MEWTWO
#define FLAG_FOUGHT_MEWTWO (0xA40 + 0x2BC)
#undef FLAG_FOUGHT_MOLTRES
#define FLAG_FOUGHT_MOLTRES (0xA40 + 0x2BD)
#undef FLAG_FOUGHT_ARTICUNO
#define FLAG_FOUGHT_ARTICUNO (0xA40 + 0x2BE)
#undef FLAG_FOUGHT_ZAPDOS
#define FLAG_FOUGHT_ZAPDOS (0xA40 + 0x2BF)
#undef FLAG_TUTOR_DOUBLE_EDGE
#define FLAG_TUTOR_DOUBLE_EDGE (0xA40 + 0x2C0)
#undef FLAG_TUTOR_THUNDER_WAVE
#define FLAG_TUTOR_THUNDER_WAVE (0xA40 + 0x2C1)
#undef FLAG_TUTOR_ROCK_SLIDE
#define FLAG_TUTOR_ROCK_SLIDE (0xA40 + 0x2C2)
#undef FLAG_TUTOR_EXPLOSION
#define FLAG_TUTOR_EXPLOSION (0xA40 + 0x2C3)
#undef FLAG_TUTOR_MEGA_PUNCH
#define FLAG_TUTOR_MEGA_PUNCH (0xA40 + 0x2C4)
#undef FLAG_TUTOR_MEGA_KICK
#define FLAG_TUTOR_MEGA_KICK (0xA40 + 0x2C5)
#undef FLAG_TUTOR_DREAM_EATER
#define FLAG_TUTOR_DREAM_EATER (0xA40 + 0x2C6)
#undef FLAG_TUTOR_SOFT_BOILED
#define FLAG_TUTOR_SOFT_BOILED (0xA40 + 0x2C7)
#undef FLAG_TUTOR_SUBSTITUTE
#define FLAG_TUTOR_SUBSTITUTE (0xA40 + 0x2C8)
#undef FLAG_TUTOR_SWORDS_DANCE
#define FLAG_TUTOR_SWORDS_DANCE (0xA40 + 0x2C9)
#undef FLAG_TUTOR_SEISMIC_TOSS
#define FLAG_TUTOR_SEISMIC_TOSS (0xA40 + 0x2CA)
#undef FLAG_TUTOR_COUNTER
#define FLAG_TUTOR_COUNTER (0xA40 + 0x2CB)
#undef FLAG_TUTOR_METRONOME
#define FLAG_TUTOR_METRONOME (0xA40 + 0x2CC)
#undef FLAG_TUTOR_MIMIC
#define FLAG_TUTOR_MIMIC (0xA40 + 0x2CD)
#undef FLAG_TUTOR_BODY_SLAM
#define FLAG_TUTOR_BODY_SLAM (0xA40 + 0x2CE)
#undef FLAG_VISITED_OAKS_LAB
#define FLAG_VISITED_OAKS_LAB (0xA40 + 0x2CF)
#undef FLAG_FOUGHT_POWER_PLANT_ELECTRODE_1
#define FLAG_FOUGHT_POWER_PLANT_ELECTRODE_1 (0xA40 + 0x2D0)
#undef FLAG_FOUGHT_POWER_PLANT_ELECTRODE_2
#define FLAG_FOUGHT_POWER_PLANT_ELECTRODE_2 (0xA40 + 0x2D1)
#undef FLAG_STOPPED_SEAFOAM_B3F_CURRENT
#define FLAG_STOPPED_SEAFOAM_B3F_CURRENT (0xA40 + 0x2D2)
#undef FLAG_STOPPED_SEAFOAM_B4F_CURRENT
#define FLAG_STOPPED_SEAFOAM_B4F_CURRENT (0xA40 + 0x2D3)
#undef FLAG_TALKED_TO_LORELEI_AFTER_WAREHOUSE
#define FLAG_TALKED_TO_LORELEI_AFTER_WAREHOUSE (0xA40 + 0x2D4)
#undef FLAG_DEFEATED_ROCKETS_IN_WAREHOUSE
#define FLAG_DEFEATED_ROCKETS_IN_WAREHOUSE (0xA40 + 0x2D5)
#undef FLAG_UNLOCKED_ROCKET_WAREHOUSE
#define FLAG_UNLOCKED_ROCKET_WAREHOUSE (0xA40 + 0x2D6)
#undef FLAG_NO_ROOM_FOR_TM42_AT_MEMORIAL_PILLAR
#define FLAG_NO_ROOM_FOR_TM42_AT_MEMORIAL_PILLAR (0xA40 + 0x2D7)
#undef FLAG_LEARNED_YES_NAH_CHANSEY
#define FLAG_LEARNED_YES_NAH_CHANSEY (0xA40 + 0x2D8)
#undef FLAG_GOT_NEST_BALL_FROM_WATER_PATH_HOUSE_1
#define FLAG_GOT_NEST_BALL_FROM_WATER_PATH_HOUSE_1 (0xA40 + 0x2D9)
#undef FLAG_GOT_TOGEPI_EGG
#define FLAG_GOT_TOGEPI_EGG (0xA40 + 0x2DA)
#undef FLAG_NO_ROOM_FOR_TOGEPI_EGG
#define FLAG_NO_ROOM_FOR_TOGEPI_EGG (0xA40 + 0x2DB)
#undef FLAG_RECOVERED_SAPPHIRE
#define FLAG_RECOVERED_SAPPHIRE (0xA40 + 0x2DC)
#undef FLAG_GOT_RUBY
#define FLAG_GOT_RUBY (0xA40 + 0x2DD)
#undef FLAG_TUTOR_FRENZY_PLANT
#define FLAG_TUTOR_FRENZY_PLANT (0xA40 + 0x2DE)
#undef FLAG_TUTOR_BLAST_BURN
#define FLAG_TUTOR_BLAST_BURN (0xA40 + 0x2DF)
#undef FLAG_TUTOR_HYDRO_CANNON
#define FLAG_TUTOR_HYDRO_CANNON (0xA40 + 0x2E0)
#undef FLAG_LEARNED_ALL_MOVES_AT_CAPE_BRINK
#define FLAG_LEARNED_ALL_MOVES_AT_CAPE_BRINK (0xA40 + 0x2E1)
#undef FLAG_GOT_NUGGET_FROM_DUNSPARCE_TUNNEL
#define FLAG_GOT_NUGGET_FROM_DUNSPARCE_TUNNEL (0xA40 + 0x2E2)
#undef FLAG_USED_CUT_ON_RUIN_VALLEY_BRAILLE
#define FLAG_USED_CUT_ON_RUIN_VALLEY_BRAILLE (0xA40 + 0x2E3)
#undef FLAG_FOUGHT_DEOXYS
#define FLAG_FOUGHT_DEOXYS (0xA40 + 0x2E4)
#undef FLAG_REVIVED_DOME
#define FLAG_REVIVED_DOME (0xA40 + 0x2EC)
#undef FLAG_REVIVED_HELIX
#define FLAG_REVIVED_HELIX (0xA40 + 0x2ED)
#undef FLAG_REVIVED_AMBER
#define FLAG_REVIVED_AMBER (0xA40 + 0x2EE)
#undef FLAG_GOT_HM06
#define FLAG_GOT_HM06 (0xA40 + 0x2EF)
#undef FLAG_FOUGHT_LUGIA
#define FLAG_FOUGHT_LUGIA (0xA40 + 0x2F2)
#undef FLAG_FOUGHT_HO_OH
#define FLAG_FOUGHT_HO_OH (0xA40 + 0x2F3)
#undef FLAG_OAK_SAW_DEX_COMPLETION
#define FLAG_OAK_SAW_DEX_COMPLETION (0xA40 + 0x2F4)
#undef FLAG_LUGIA_FLEW_AWAY
#define FLAG_LUGIA_FLEW_AWAY (0xA40 + 0x2F5)
#undef FLAG_HO_OH_FLEW_AWAY
#define FLAG_HO_OH_FLEW_AWAY (0xA40 + 0x2F6)
#undef FLAG_DEOXYS_FLEW_AWAY
#define FLAG_DEOXYS_FLEW_AWAY (0xA40 + 0x2F7)
#undef FLAG_TALKED_TO_TEA_LADY_AFTER_HOF
#define FLAG_TALKED_TO_TEA_LADY_AFTER_HOF (0xA40 + 0x2F8)
#undef FLAG_TALKED_TO_OAKS_AIDE_IN_VERMILION
#define FLAG_TALKED_TO_OAKS_AIDE_IN_VERMILION (0xA40 + 0x2F9)
#undef FLAG_GOT_EVERSTONE_FROM_OAKS_AIDE
#define FLAG_GOT_EVERSTONE_FROM_OAKS_AIDE (0xA40 + 0x2FA)
#undef FLAG_GOT_MOON_STONE_FROM_JOYFUL_GAME_CORNER
#define FLAG_GOT_MOON_STONE_FROM_JOYFUL_GAME_CORNER (0xA40 + 0x2FB)
#undef FLAG_GOT_FULL_RESTORE_FROM_THREE_ISLAND_DEFENDER
#define FLAG_GOT_FULL_RESTORE_FROM_THREE_ISLAND_DEFENDER (0xA40 + 0x2FC)
#undef FLAG_GOT_AMULET_COIN_FROM_OAKS_AIDE
#define FLAG_GOT_AMULET_COIN_FROM_OAKS_AIDE (0xA40 + 0x2FD)
#undef FLAG_NO_ROOM_FOR_JOYFUL_GAME_CORNER_MOON_STONE
#define FLAG_NO_ROOM_FOR_JOYFUL_GAME_CORNER_MOON_STONE (0xA40 + 0x2FE)
#undef FLAG_OAKS_RATING_IS_VIA_PC
#define FLAG_OAKS_RATING_IS_VIA_PC (0xA40 + 0x2FF)
#undef FLAG_HIDDEN_ITEM_VIRIDIAN_FOREST_POTION
#define FLAG_HIDDEN_ITEM_VIRIDIAN_FOREST_POTION (FLAG_HIDDEN_ITEMS_START + 0x70)
#undef FLAG_HIDDEN_ITEM_VIRIDIAN_FOREST_ANTIDOTE
#define FLAG_HIDDEN_ITEM_VIRIDIAN_FOREST_ANTIDOTE (FLAG_HIDDEN_ITEMS_START + 0x71)
#undef FLAG_HIDDEN_ITEM_MT_MOON_B2F_MOON_STONE
#define FLAG_HIDDEN_ITEM_MT_MOON_B2F_MOON_STONE (FLAG_HIDDEN_ITEMS_START + 0x72)
#undef FLAG_HIDDEN_ITEM_MT_MOON_B2F_ETHER
#define FLAG_HIDDEN_ITEM_MT_MOON_B2F_ETHER (FLAG_HIDDEN_ITEMS_START + 0x73)
#undef FLAG_HIDDEN_ITEM_ROUTE25_ELIXIR
#define FLAG_HIDDEN_ITEM_ROUTE25_ELIXIR (FLAG_HIDDEN_ITEMS_START + 0x74)
#undef FLAG_HIDDEN_ITEM_ROUTE25_ETHER
#define FLAG_HIDDEN_ITEM_ROUTE25_ETHER (FLAG_HIDDEN_ITEMS_START + 0x75)
#undef FLAG_HIDDEN_ITEM_ROUTE9_ETHER
#define FLAG_HIDDEN_ITEM_ROUTE9_ETHER (FLAG_HIDDEN_ITEMS_START + 0x76)
#undef FLAG_HIDDEN_ITEM_SSANNE_B1F_CORRIDOR_HYPER_POTION
#define FLAG_HIDDEN_ITEM_SSANNE_B1F_CORRIDOR_HYPER_POTION (FLAG_HIDDEN_ITEMS_START + 0x78)
#undef FLAG_HIDDEN_ITEM_ROUTE10_SUPER_POTION
#define FLAG_HIDDEN_ITEM_ROUTE10_SUPER_POTION (FLAG_HIDDEN_ITEMS_START + 0x79)
#undef FLAG_HIDDEN_ITEM_ROUTE10_MAX_ETHER
#define FLAG_HIDDEN_ITEM_ROUTE10_MAX_ETHER (FLAG_HIDDEN_ITEMS_START + 0x7A)
#undef FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B1F_PP_UP
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B1F_PP_UP (FLAG_HIDDEN_ITEMS_START + 0x7B)
#undef FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B3F_NUGGET
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B3F_NUGGET (FLAG_HIDDEN_ITEMS_START + 0x7C)
#undef FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B4F_NEST_BALL
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B4F_NEST_BALL (FLAG_HIDDEN_ITEMS_START + 0x7D)
#undef FLAG_HIDDEN_ITEM_POKEMON_TOWER_5F_BIG_MUSHROOM
#define FLAG_HIDDEN_ITEM_POKEMON_TOWER_5F_BIG_MUSHROOM (FLAG_HIDDEN_ITEMS_START + 0x7E)
#undef FLAG_HIDDEN_ITEM_ROUTE13_PP_UP
#define FLAG_HIDDEN_ITEM_ROUTE13_PP_UP (FLAG_HIDDEN_ITEMS_START + 0x7F)
#undef FLAG_HIDDEN_ITEM_ROUTE17_RARE_CANDY
#define FLAG_HIDDEN_ITEM_ROUTE17_RARE_CANDY (FLAG_HIDDEN_ITEMS_START + 0x81)
#undef FLAG_HIDDEN_ITEM_ROUTE17_FULL_RESTORE
#define FLAG_HIDDEN_ITEM_ROUTE17_FULL_RESTORE (FLAG_HIDDEN_ITEMS_START + 0x82)
#undef FLAG_HIDDEN_ITEM_ROUTE17_PP_UP
#define FLAG_HIDDEN_ITEM_ROUTE17_PP_UP (FLAG_HIDDEN_ITEMS_START + 0x83)
#undef FLAG_HIDDEN_ITEM_ROUTE17_MAX_REVIVE
#define FLAG_HIDDEN_ITEM_ROUTE17_MAX_REVIVE (FLAG_HIDDEN_ITEMS_START + 0x84)
#undef FLAG_HIDDEN_ITEM_ROUTE17_MAX_ELIXIR
#define FLAG_HIDDEN_ITEM_ROUTE17_MAX_ELIXIR (FLAG_HIDDEN_ITEMS_START + 0x85)
#undef FLAG_HIDDEN_ITEM_SAFARI_ZONE_CENTER_LEAF_STONE
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_CENTER_LEAF_STONE (FLAG_HIDDEN_ITEMS_START + 0x86)
#undef FLAG_HIDDEN_ITEM_SAFARI_ZONE_WEST_REVIVE
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_WEST_REVIVE (FLAG_HIDDEN_ITEMS_START + 0x87)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_5F_ELIXIR
#define FLAG_HIDDEN_ITEM_SILPH_CO_5F_ELIXIR (FLAG_HIDDEN_ITEMS_START + 0x88)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_9F_MAX_POTION
#define FLAG_HIDDEN_ITEM_SILPH_CO_9F_MAX_POTION (FLAG_HIDDEN_ITEMS_START + 0x89)
#undef FLAG_HIDDEN_ITEM_SAFFRON_CITY_COPYCATS_HOUSE_2F_NUGGET
#define FLAG_HIDDEN_ITEM_SAFFRON_CITY_COPYCATS_HOUSE_2F_NUGGET (FLAG_HIDDEN_ITEMS_START + 0x8A)
#undef FLAG_HIDDEN_ITEM_POWER_PLANT_MAX_ELIXIR
#define FLAG_HIDDEN_ITEM_POWER_PLANT_MAX_ELIXIR (FLAG_HIDDEN_ITEMS_START + 0x8B)
#undef FLAG_HIDDEN_ITEM_POWER_PLANT_THUNDER_STONE
#define FLAG_HIDDEN_ITEM_POWER_PLANT_THUNDER_STONE (FLAG_HIDDEN_ITEMS_START + 0x8C)
#undef FLAG_HIDDEN_ITEM_SEAFOAM_ISLANDS_B3F_NUGGET
#define FLAG_HIDDEN_ITEM_SEAFOAM_ISLANDS_B3F_NUGGET (FLAG_HIDDEN_ITEMS_START + 0x8D)
#undef FLAG_HIDDEN_ITEM_SEAFOAM_ISLANDS_B4F_WATER_STONE
#define FLAG_HIDDEN_ITEM_SEAFOAM_ISLANDS_B4F_WATER_STONE (FLAG_HIDDEN_ITEMS_START + 0x8E)
#undef FLAG_HIDDEN_ITEM_POKEMON_MANSION_1F_MOON_STONE
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_1F_MOON_STONE (FLAG_HIDDEN_ITEMS_START + 0x8F)
#undef FLAG_HIDDEN_ITEM_POKEMON_MANSION_3F_RARE_CANDY
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_3F_RARE_CANDY (FLAG_HIDDEN_ITEMS_START + 0x90)
#undef FLAG_HIDDEN_ITEM_POKEMON_MANSION_B1F_ELIXIR
#define FLAG_HIDDEN_ITEM_POKEMON_MANSION_B1F_ELIXIR (FLAG_HIDDEN_ITEMS_START + 0x91)
#undef FLAG_HIDDEN_ITEM_ROUTE23_FULL_RESTORE
#define FLAG_HIDDEN_ITEM_ROUTE23_FULL_RESTORE (FLAG_HIDDEN_ITEMS_START + 0x92)
...
#define FLAG_HIDDEN_ITEM_ROUTE23_MAX_ETHER (FLAG_HIDDEN_ITEMS_START + 0x94)
#undef FLAG_HIDDEN_ITEM_VICTORY_ROAD_1F_FULL_RESTORE
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_1F_FULL_RESTORE (FLAG_HIDDEN_ITEMS_START + 0x96)
#undef FLAG_HIDDEN_ITEM_CERULEAN_CAVE_1F_ULTRA_BALL
#define FLAG_HIDDEN_ITEM_CERULEAN_CAVE_1F_ULTRA_BALL (FLAG_HIDDEN_ITEMS_START + 0x97)
#undef FLAG_HIDDEN_ITEM_ROUTE11_ESCAPE_ROPE
#define FLAG_HIDDEN_ITEM_ROUTE11_ESCAPE_ROPE (FLAG_HIDDEN_ITEMS_START + 0x99)
#undef FLAG_HIDDEN_ITEM_ROUTE12_HYPER_POTION
#define FLAG_HIDDEN_ITEM_ROUTE12_HYPER_POTION (FLAG_HIDDEN_ITEMS_START + 0x9A)
#undef FLAG_HIDDEN_ITEM_CELADON_CITY_PP_UP
#define FLAG_HIDDEN_ITEM_CELADON_CITY_PP_UP (FLAG_HIDDEN_ITEMS_START + 0x9F)
#undef FLAG_HIDDEN_ITEM_VERMILION_CITY_MAX_ETHER
#define FLAG_HIDDEN_ITEM_VERMILION_CITY_MAX_ETHER (FLAG_HIDDEN_ITEMS_START + 0xA0)
#undef FLAG_HIDDEN_ITEM_CERULEAN_CITY_RARE_CANDY
#define FLAG_HIDDEN_ITEM_CERULEAN_CITY_RARE_CANDY (FLAG_HIDDEN_ITEMS_START + 0xA1)
#undef FLAG_HIDDEN_ITEM_ROUTE4_GREAT_BALL
#define FLAG_HIDDEN_ITEM_ROUTE4_GREAT_BALL (FLAG_HIDDEN_ITEMS_START + 0xA2)
...
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_SEVAULT_CANYON_CHERI_BERRY (FLAG_HIDDEN_ITEMS_START + 0xAF)
#undef FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_4
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_4 (FLAG_HIDDEN_ITEMS_START + 0xB0)
#undef FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE (FLAG_HIDDEN_ITEMS_START + 0xB1)
#undef FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_2
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_2 (FLAG_HIDDEN_ITEMS_START + 0xB2)
#undef FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_3
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TANOBY_RUINS_HEART_SCALE_3 (FLAG_HIDDEN_ITEMS_START + 0xB3)
#undef FLAG_HIDDEN_ITEM_FIVE_ISLAND_ROCKET_WAREHOUSE_NEST_BALL
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_ROCKET_WAREHOUSE_NEST_BALL (FLAG_HIDDEN_ITEMS_START + 0xB4)
#undef FLAG_HIDDEN_ITEM_FIVE_ISLAND_ROCKET_WAREHOUSE_NET_BALL
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_ROCKET_WAREHOUSE_NET_BALL (FLAG_HIDDEN_ITEMS_START + 0xB5)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_POTION
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_POTION (FLAG_HIDDEN_ITEMS_START + 0xB6)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ANTIDOTE
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ANTIDOTE (FLAG_HIDDEN_ITEMS_START + 0xB7)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_PARALYZE_HEAL
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_PARALYZE_HEAL (FLAG_HIDDEN_ITEMS_START + 0xB8)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_AWAKENING
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_AWAKENING (FLAG_HIDDEN_ITEMS_START + 0xB9)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_BURN_HEAL
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_BURN_HEAL (FLAG_HIDDEN_ITEMS_START + 0xBA)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ICE_HEAL
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ICE_HEAL (FLAG_HIDDEN_ITEMS_START + 0xBB)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ETHER
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL_ETHER (FLAG_HIDDEN_ITEMS_START + 0xBC)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_POTION
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_POTION (FLAG_HIDDEN_ITEMS_START + 0xBD)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ANTIDOTE
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ANTIDOTE (FLAG_HIDDEN_ITEMS_START + 0xBE)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_PARALYZE_HEAL
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_PARALYZE_HEAL (FLAG_HIDDEN_ITEMS_START + 0xBF)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_AWAKENING
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_AWAKENING (FLAG_HIDDEN_ITEMS_START + 0xC0)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_BURN_HEAL
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_BURN_HEAL (FLAG_HIDDEN_ITEMS_START + 0xC1)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ICE_HEAL
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ICE_HEAL (FLAG_HIDDEN_ITEMS_START + 0xC2)
#undef FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ETHER
#define FLAG_HIDDEN_ITEM_UNDERGROUND_PATH_EAST_WEST_TUNNEL_ETHER (FLAG_HIDDEN_ITEMS_START + 0xC3)
#undef FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM (FLAG_HIDDEN_ITEMS_START + 0xC4)
#undef FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM_2
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM_2 (FLAG_HIDDEN_ITEMS_START + 0xC5)
#undef FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM_3
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_TINY_MUSHROOM_3 (FLAG_HIDDEN_ITEMS_START + 0xC6)
#undef FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM (FLAG_HIDDEN_ITEMS_START + 0xC7)
#undef FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM_2
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM_2 (FLAG_HIDDEN_ITEMS_START + 0xC8)
#undef FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM_3
#define FLAG_HIDDEN_ITEM_MT_MOON_B1F_BIG_MUSHROOM_3 (FLAG_HIDDEN_ITEMS_START + 0xC9)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAZZ_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAZZ_BERRY (FLAG_HIDDEN_ITEMS_START + 0xCA)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_BLUK_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_BLUK_BERRY (FLAG_HIDDEN_ITEMS_START + 0xCB)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_NANAB_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_NANAB_BERRY (FLAG_HIDDEN_ITEMS_START + 0xCC)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_WEPEAR_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_WEPEAR_BERRY (FLAG_HIDDEN_ITEMS_START + 0xCD)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ORAN_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ORAN_BERRY (FLAG_HIDDEN_ITEMS_START + 0xCE)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHERI_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHERI_BERRY (FLAG_HIDDEN_ITEMS_START + 0xCF)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHESTO_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHESTO_BERRY (FLAG_HIDDEN_ITEMS_START + 0xD0)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PECHA_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PECHA_BERRY (FLAG_HIDDEN_ITEMS_START + 0xD1)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAWST_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAWST_BERRY (FLAG_HIDDEN_ITEMS_START + 0xD2)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ASPEAR_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ASPEAR_BERRY (FLAG_HIDDEN_ITEMS_START + 0xD3)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PERSIM_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PERSIM_BERRY (FLAG_HIDDEN_ITEMS_START + 0xD4)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PINAP_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PINAP_BERRY (FLAG_HIDDEN_ITEMS_START + 0xD5)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_LUM_BERRY
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_LUM_BERRY (FLAG_HIDDEN_ITEMS_START + 0xD6)
#undef FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STARDUST
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STARDUST (FLAG_HIDDEN_ITEMS_START + 0xD7)
#undef FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STARDUST_2
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STARDUST_2 (FLAG_HIDDEN_ITEMS_START + 0xD8)
#undef FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_PEARL
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_PEARL (FLAG_HIDDEN_ITEMS_START + 0xD9)
#undef FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_PEARL_2
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_PEARL_2 (FLAG_HIDDEN_ITEMS_START + 0xDA)
#undef FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL (FLAG_HIDDEN_ITEMS_START + 0xDB)
#undef FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL_2
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL_2 (FLAG_HIDDEN_ITEMS_START + 0xDC)
#undef FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STAR_PIECE
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_STAR_PIECE (FLAG_HIDDEN_ITEMS_START + 0xDD)
#undef FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_BIG_PEARL
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_BIG_PEARL (FLAG_HIDDEN_ITEMS_START + 0xDE)
#undef FLAG_HIDDEN_ITEM_TWO_ISLAND_CAPE_BRINK_RARE_CANDY
#define FLAG_HIDDEN_ITEM_TWO_ISLAND_CAPE_BRINK_RARE_CANDY (FLAG_HIDDEN_ITEMS_START + 0xDF)
#undef FLAG_HIDDEN_ITEM_PEWTER_CITY_POKE_BALL
#define FLAG_HIDDEN_ITEM_PEWTER_CITY_POKE_BALL (FLAG_HIDDEN_ITEMS_START + 0xE0)
#undef FLAG_HIDDEN_ITEM_ROUTE3_ORAN_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE3_ORAN_BERRY (FLAG_HIDDEN_ITEMS_START + 0xE1)
#undef FLAG_HIDDEN_ITEM_ROUTE4_PERSIM_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE4_PERSIM_BERRY (FLAG_HIDDEN_ITEMS_START + 0xE2)
#undef FLAG_HIDDEN_ITEM_ROUTE24_PECHA_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE24_PECHA_BERRY (FLAG_HIDDEN_ITEMS_START + 0xE3)
#undef FLAG_HIDDEN_ITEM_ROUTE25_ORAN_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE25_ORAN_BERRY (FLAG_HIDDEN_ITEMS_START + 0xE4)
#undef FLAG_HIDDEN_ITEM_ROUTE25_BLUK_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE25_BLUK_BERRY (FLAG_HIDDEN_ITEMS_START + 0xE5)
#undef FLAG_HIDDEN_ITEM_ROUTE6_SITRUS_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE6_SITRUS_BERRY (FLAG_HIDDEN_ITEMS_START + 0xE6)
#undef FLAG_HIDDEN_ITEM_ROUTE6_RARE_CANDY
#define FLAG_HIDDEN_ITEM_ROUTE6_RARE_CANDY (FLAG_HIDDEN_ITEMS_START + 0xE7)
#undef FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_PECHA_BERRY
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_PECHA_BERRY (FLAG_HIDDEN_ITEMS_START + 0xE8)
#undef FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_CHERI_BERRY
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_CHERI_BERRY (FLAG_HIDDEN_ITEMS_START + 0xE9)
#undef FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_CHESTO_BERRY
#define FLAG_HIDDEN_ITEM_SSANNE_KITCHEN_CHESTO_BERRY (FLAG_HIDDEN_ITEMS_START + 0xEA)
#undef FLAG_HIDDEN_ITEM_ROUTE9_RARE_CANDY
#define FLAG_HIDDEN_ITEM_ROUTE9_RARE_CANDY (FLAG_HIDDEN_ITEMS_START + 0xEB)
#undef FLAG_HIDDEN_ITEM_ROUTE10_PERSIM_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE10_PERSIM_BERRY (FLAG_HIDDEN_ITEMS_START + 0xED)
#undef FLAG_HIDDEN_ITEM_ROUTE10_CHERI_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE10_CHERI_BERRY (FLAG_HIDDEN_ITEMS_START + 0xEE)
#undef FLAG_HIDDEN_ITEM_ROUTE8_RAWST_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE8_RAWST_BERRY (FLAG_HIDDEN_ITEMS_START + 0xEF)
#undef FLAG_HIDDEN_ITEM_ROUTE8_LUM_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE8_LUM_BERRY (FLAG_HIDDEN_ITEMS_START + 0xF0)
#undef FLAG_HIDDEN_ITEM_ROUTE8_LEPPA_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE8_LEPPA_BERRY (FLAG_HIDDEN_ITEMS_START + 0xF1)
#undef FLAG_HIDDEN_ITEM_ROUTE12_RARE_CANDY
#define FLAG_HIDDEN_ITEM_ROUTE12_RARE_CANDY (FLAG_HIDDEN_ITEMS_START + 0xF2)
#undef FLAG_HIDDEN_ITEM_ROUTE12_LEFTOVERS
#define FLAG_HIDDEN_ITEM_ROUTE12_LEFTOVERS (FLAG_HIDDEN_ITEMS_START + 0xF3)
#undef FLAG_HIDDEN_ITEM_ROUTE16_LEFTOVERS
#define FLAG_HIDDEN_ITEM_ROUTE16_LEFTOVERS (FLAG_HIDDEN_ITEMS_START + 0xF4)
#undef FLAG_HIDDEN_ITEM_FUCHSIA_CITY_MAX_REVIVE
#define FLAG_HIDDEN_ITEM_FUCHSIA_CITY_MAX_REVIVE (FLAG_HIDDEN_ITEMS_START + 0xF5)
#undef FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B4F_NET_BALL
#define FLAG_HIDDEN_ITEM_ROCKET_HIDEOUT_B4F_NET_BALL (FLAG_HIDDEN_ITEMS_START + 0xF6)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_2F_ULTRA_BALL
#define FLAG_HIDDEN_ITEM_SILPH_CO_2F_ULTRA_BALL (FLAG_HIDDEN_ITEMS_START + 0xF7)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_3F_PROTEIN
#define FLAG_HIDDEN_ITEM_SILPH_CO_3F_PROTEIN (FLAG_HIDDEN_ITEMS_START + 0xF8)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_4F_IRON
#define FLAG_HIDDEN_ITEM_SILPH_CO_4F_IRON (FLAG_HIDDEN_ITEMS_START + 0xF9)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_5F_PP_UP
#define FLAG_HIDDEN_ITEM_SILPH_CO_5F_PP_UP (FLAG_HIDDEN_ITEMS_START + 0xFA)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_6F_CARBOS
#define FLAG_HIDDEN_ITEM_SILPH_CO_6F_CARBOS (FLAG_HIDDEN_ITEMS_START + 0xFB)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_7F_ZINC
#define FLAG_HIDDEN_ITEM_SILPH_CO_7F_ZINC (FLAG_HIDDEN_ITEMS_START + 0xFC)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_8F_NUGGET
#define FLAG_HIDDEN_ITEM_SILPH_CO_8F_NUGGET (FLAG_HIDDEN_ITEMS_START + 0xFD)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_9F_CALCIUM
#define FLAG_HIDDEN_ITEM_SILPH_CO_9F_CALCIUM (FLAG_HIDDEN_ITEMS_START + 0xFE)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_10F_HP_UP
#define FLAG_HIDDEN_ITEM_SILPH_CO_10F_HP_UP (FLAG_HIDDEN_ITEMS_START + 0xFF)
#undef FLAG_HIDDEN_ITEM_SILPH_CO_11F_REVIVE
#define FLAG_HIDDEN_ITEM_SILPH_CO_11F_REVIVE (FLAG_HIDDEN_ITEMS_START + 0x100)
#undef FLAG_HIDDEN_ITEM_ROUTE23_LUM_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE23_LUM_BERRY (FLAG_HIDDEN_ITEMS_START + 0x101)
#undef FLAG_HIDDEN_ITEM_ROUTE23_SITRUS_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE23_SITRUS_BERRY (FLAG_HIDDEN_ITEMS_START + 0x102)
#undef FLAG_HIDDEN_ITEM_ROUTE23_ASPEAR_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE23_ASPEAR_BERRY (FLAG_HIDDEN_ITEMS_START + 0x103)
#undef FLAG_HIDDEN_ITEM_ROUTE23_LEPPA_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE23_LEPPA_BERRY (FLAG_HIDDEN_ITEMS_START + 0x104)
#undef FLAG_HIDDEN_ITEM_ROUTE14_ZINC
#define FLAG_HIDDEN_ITEM_ROUTE14_ZINC (FLAG_HIDDEN_ITEMS_START + 0x105)
#undef FLAG_HIDDEN_ITEM_ROUTE9_CHESTO_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE9_CHESTO_BERRY (FLAG_HIDDEN_ITEMS_START + 0x106)
#undef FLAG_HIDDEN_ITEM_ROUTE10_NANAB_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE10_NANAB_BERRY (FLAG_HIDDEN_ITEMS_START + 0x107)
#undef FLAG_HIDDEN_ITEM_ROUTE7_WEPEAR_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE7_WEPEAR_BERRY (FLAG_HIDDEN_ITEMS_START + 0x108)
#undef FLAG_HIDDEN_ITEM_ROUTE20_STARDUST
#define FLAG_HIDDEN_ITEM_ROUTE20_STARDUST (FLAG_HIDDEN_ITEMS_START + 0x109)
#undef FLAG_HIDDEN_ITEM_ROUTE21_NORTH_PEARL
#define FLAG_HIDDEN_ITEM_ROUTE21_NORTH_PEARL (FLAG_HIDDEN_ITEMS_START + 0x10A)
#undef FLAG_HIDDEN_ITEM_ROUTE23_MAX_ELIXIR
#define FLAG_HIDDEN_ITEM_ROUTE23_MAX_ELIXIR (FLAG_HIDDEN_ITEMS_START + 0x10B)
#undef FLAG_HIDDEN_ITEM_ROUTE4_RAZZ_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE4_RAZZ_BERRY (FLAG_HIDDEN_ITEMS_START + 0x10C)
#undef FLAG_HIDDEN_ITEM_ROUTE14_PINAP_BERRY
#define FLAG_HIDDEN_ITEM_ROUTE14_PINAP_BERRY (FLAG_HIDDEN_ITEMS_START + 0x10D)
#undef FLAG_HIDDEN_ITEM_MT_EMBER_EXTERIOR_FIRE_STONE
#define FLAG_HIDDEN_ITEM_MT_EMBER_EXTERIOR_FIRE_STONE (FLAG_HIDDEN_ITEMS_START + 0x10E)
#undef FLAG_HIDDEN_ITEM_POKEMON_TOWER_7F_SOOTHE_BELL
#define FLAG_HIDDEN_ITEM_POKEMON_TOWER_7F_SOOTHE_BELL (FLAG_HIDDEN_ITEMS_START + 0x10F)
#undef FLAG_HIDDEN_ITEM_NAVEL_ROCK_SUMMIT_SACRED_ASH
#define FLAG_HIDDEN_ITEM_NAVEL_ROCK_SUMMIT_SACRED_ASH (FLAG_HIDDEN_ITEMS_START + 0x110)
#undef FLAG_HIDDEN_ITEM_TWO_ISLAND_CAPE_BRINK_PP_MAX
#define FLAG_HIDDEN_ITEM_TWO_ISLAND_CAPE_BRINK_PP_MAX (FLAG_HIDDEN_ITEMS_START + 0x111)
#undef FLAG_HIDDEN_ITEM_MT_EMBER_EXTERIOR_ULTRA_BALL
#define FLAG_HIDDEN_ITEM_MT_EMBER_EXTERIOR_ULTRA_BALL (FLAG_HIDDEN_ITEMS_START + 0x112)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_DUNSPARCE_TUNNEL_NUGGET
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_DUNSPARCE_TUNNEL_NUGGET (FLAG_HIDDEN_ITEMS_START + 0x113)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_PP_UP
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_PP_UP (FLAG_HIDDEN_ITEMS_START + 0x114)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_MAX_REPEL
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_MAX_REPEL (FLAG_HIDDEN_ITEMS_START + 0x115)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_PEARL
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_PEARL (FLAG_HIDDEN_ITEMS_START + 0x116)
#undef FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_STARDUST
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BOND_BRIDGE_STARDUST (FLAG_HIDDEN_ITEMS_START + 0x117)
#undef FLAG_HIDDEN_ITEM_FOUR_ISLAND_PEARL
#define FLAG_HIDDEN_ITEM_FOUR_ISLAND_PEARL (FLAG_HIDDEN_ITEMS_START + 0x118)
#undef FLAG_HIDDEN_ITEM_FOUR_ISLAND_ULTRA_BALL
#define FLAG_HIDDEN_ITEM_FOUR_ISLAND_ULTRA_BALL (FLAG_HIDDEN_ITEMS_START + 0x119)
#undef FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_BIG_PEARL
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_BIG_PEARL (FLAG_HIDDEN_ITEMS_START + 0x11A)
#undef FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_RAZZ_BERRY
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_RAZZ_BERRY (FLAG_HIDDEN_ITEMS_START + 0x11B)
#undef FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_SITRUS_BERRY
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_SITRUS_BERRY (FLAG_HIDDEN_ITEMS_START + 0x11C)
#undef FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_BLUK_BERRY
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_BLUK_BERRY (FLAG_HIDDEN_ITEMS_START + 0x11D)
#undef FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_NEST_BALL
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_NEST_BALL (FLAG_HIDDEN_ITEMS_START + 0x11E)
#undef FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STARDUST
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STARDUST (FLAG_HIDDEN_ITEMS_START + 0x11F)
#undef FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STAR_PIECE
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STAR_PIECE (FLAG_HIDDEN_ITEMS_START + 0x120)
#undef FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STARDUST_2
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_RESORT_GORGEOUS_STARDUST_2 (FLAG_HIDDEN_ITEMS_START + 0x121)
#undef FLAG_HIDDEN_ITEM_SIX_ISLAND_OUTCAST_ISLAND_STAR_PIECE
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_OUTCAST_ISLAND_STAR_PIECE (FLAG_HIDDEN_ITEMS_START + 0x122)
#undef FLAG_HIDDEN_ITEM_SIX_ISLAND_OUTCAST_ISLAND_NET_BALL
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_OUTCAST_ISLAND_NET_BALL (FLAG_HIDDEN_ITEMS_START + 0x123)
#undef FLAG_HIDDEN_ITEM_SIX_ISLAND_GREEN_PATH_ULTRA_BALL
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_GREEN_PATH_ULTRA_BALL (FLAG_HIDDEN_ITEMS_START + 0x124)
#undef FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_ASPEAR_BERRY
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_ASPEAR_BERRY (FLAG_HIDDEN_ITEMS_START + 0x125)
#undef FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_ORAN_BERRY
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_ORAN_BERRY (FLAG_HIDDEN_ITEMS_START + 0x126)
#undef FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_PINAP_BERRY
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_WATER_PATH_PINAP_BERRY (FLAG_HIDDEN_ITEMS_START + 0x127)
#undef FLAG_HIDDEN_ITEM_SIX_ISLAND_LEPPA_BERRY
#define FLAG_HIDDEN_ITEM_SIX_ISLAND_LEPPA_BERRY (FLAG_HIDDEN_ITEMS_START + 0x128)
#undef FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_BIG_PEARL
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_BIG_PEARL (FLAG_HIDDEN_ITEMS_START + 0x129)
#undef FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_PEARL
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_PEARL (FLAG_HIDDEN_ITEMS_START + 0x12A)
#undef FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_NANAB_BERRY
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_TRAINER_TOWER_NANAB_BERRY (FLAG_HIDDEN_ITEMS_START + 0x12B)
#undef FLAG_HIDDEN_ITEM_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE_RAWST_BERRY
#define FLAG_HIDDEN_ITEM_SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE_RAWST_BERRY (FLAG_HIDDEN_ITEMS_START + 0x12C)
#undef FLAG_HIDDEN_ITEM_VIRIDIAN_CITY_GYM_MACHO_BRACE
#define FLAG_HIDDEN_ITEM_VIRIDIAN_CITY_GYM_MACHO_BRACE (FLAG_HIDDEN_ITEMS_START + 0x12D)
#undef FLAG_HIDDEN_ITEM_SSANNE_EXTERIOR_LAVA_COOKIE
#define FLAG_HIDDEN_ITEM_SSANNE_EXTERIOR_LAVA_COOKIE (FLAG_HIDDEN_ITEMS_START + 0x12E)
#undef FLAG_DEFEATED_BROCK
#define FLAG_DEFEATED_BROCK (0xA40 + 0x4B0)
#undef FLAG_DEFEATED_MISTY
#define FLAG_DEFEATED_MISTY (0xA40 + 0x4B1)
#undef FLAG_DEFEATED_LT_SURGE
#define FLAG_DEFEATED_LT_SURGE (0xA40 + 0x4B2)
#undef FLAG_DEFEATED_ERIKA
#define FLAG_DEFEATED_ERIKA (0xA40 + 0x4B3)
#undef FLAG_DEFEATED_KOGA
#define FLAG_DEFEATED_KOGA (0xA40 + 0x4B4)
#undef FLAG_DEFEATED_SABRINA
#define FLAG_DEFEATED_SABRINA (0xA40 + 0x4B5)
#undef FLAG_DEFEATED_BLAINE
#define FLAG_DEFEATED_BLAINE (0xA40 + 0x4B6)
#undef FLAG_DEFEATED_LEADER_GIOVANNI
#define FLAG_DEFEATED_LEADER_GIOVANNI (0xA40 + 0x4B7)
#undef FLAG_DEFEATED_LORELEI
#define FLAG_DEFEATED_LORELEI (0xA40 + 0x4B8)
#undef FLAG_DEFEATED_BRUNO
#define FLAG_DEFEATED_BRUNO (0xA40 + 0x4B9)
#undef FLAG_DEFEATED_AGATHA
#define FLAG_DEFEATED_AGATHA (0xA40 + 0x4BA)
#undef FLAG_DEFEATED_LANCE
#define FLAG_DEFEATED_LANCE (0xA40 + 0x4BB)
#undef FLAG_DEFEATED_CHAMP
#define FLAG_DEFEATED_CHAMP (0xA40 + 0x4BC)

// FRLG world-map / Fly-point flags were left at the =0 temp-flag sentinel by the merge,
...
#define FLAG_WORLD_MAP_VIRIDIAN_CITY (FLAG_WORLD_MAP_BANK + 0x1)
#undef  FLAG_WORLD_MAP_PEWTER_CITY
#define FLAG_WORLD_MAP_PEWTER_CITY (FLAG_WORLD_MAP_BANK + 0x2)
#undef  FLAG_WORLD_MAP_CERULEAN_CITY
#define FLAG_WORLD_MAP_CERULEAN_CITY (FLAG_WORLD_MAP_BANK + 0x3)
#undef  FLAG_WORLD_MAP_LAVENDER_TOWN
#define FLAG_WORLD_MAP_LAVENDER_TOWN (FLAG_WORLD_MAP_BANK + 0x4)
#undef  FLAG_WORLD_MAP_VERMILION_CITY
#define FLAG_WORLD_MAP_VERMILION_CITY (FLAG_WORLD_MAP_BANK + 0x5)
#undef  FLAG_WORLD_MAP_CELADON_CITY
#define FLAG_WORLD_MAP_CELADON_CITY (FLAG_WORLD_MAP_BANK + 0x6)
#undef  FLAG_WORLD_MAP_FUCHSIA_CITY
#define FLAG_WORLD_MAP_FUCHSIA_CITY (FLAG_WORLD_MAP_BANK + 0x7)
#undef  FLAG_WORLD_MAP_CINNABAR_ISLAND
#define FLAG_WORLD_MAP_CINNABAR_ISLAND (FLAG_WORLD_MAP_BANK + 0x8)
#undef  FLAG_WORLD_MAP_INDIGO_PLATEAU_EXTERIOR
#define FLAG_WORLD_MAP_INDIGO_PLATEAU_EXTERIOR (FLAG_WORLD_MAP_BANK + 0x9)
#undef  FLAG_WORLD_MAP_SAFFRON_CITY
#define FLAG_WORLD_MAP_SAFFRON_CITY (FLAG_WORLD_MAP_BANK + 0xA)
#undef  FLAG_WORLD_MAP_ONE_ISLAND
#define FLAG_WORLD_MAP_ONE_ISLAND (FLAG_WORLD_MAP_BANK + 0xB)
#undef  FLAG_WORLD_MAP_TWO_ISLAND
#define FLAG_WORLD_MAP_TWO_ISLAND (FLAG_WORLD_MAP_BANK + 0xC)
#undef  FLAG_WORLD_MAP_THREE_ISLAND
#define FLAG_WORLD_MAP_THREE_ISLAND (FLAG_WORLD_MAP_BANK + 0xD)
#undef  FLAG_WORLD_MAP_FOUR_ISLAND
#define FLAG_WORLD_MAP_FOUR_ISLAND (FLAG_WORLD_MAP_BANK + 0xE)
#undef  FLAG_WORLD_MAP_FIVE_ISLAND
#define FLAG_WORLD_MAP_FIVE_ISLAND (FLAG_WORLD_MAP_BANK + 0xF)
#undef  FLAG_WORLD_MAP_SEVEN_ISLAND
#define FLAG_WORLD_MAP_SEVEN_ISLAND (FLAG_WORLD_MAP_BANK + 0x10)
#undef  FLAG_WORLD_MAP_SIX_ISLAND
#define FLAG_WORLD_MAP_SIX_ISLAND (FLAG_WORLD_MAP_BANK + 0x11)
#undef  FLAG_WORLD_MAP_ROUTE4_POKEMON_CENTER_1F
#define FLAG_WORLD_MAP_ROUTE4_POKEMON_CENTER_1F (FLAG_WORLD_MAP_BANK + 0x12)
#undef  FLAG_WORLD_MAP_ROUTE10_POKEMON_CENTER_1F
#define FLAG_WORLD_MAP_ROUTE10_POKEMON_CENTER_1F (FLAG_WORLD_MAP_BANK + 0x13)
#undef  FLAG_WORLD_MAP_VIRIDIAN_FOREST
#define FLAG_WORLD_MAP_VIRIDIAN_FOREST (FLAG_WORLD_MAP_BANK + 0x14)
#undef  FLAG_WORLD_MAP_MT_MOON_1F
#define FLAG_WORLD_MAP_MT_MOON_1F (FLAG_WORLD_MAP_BANK + 0x15)
#undef  FLAG_WORLD_MAP_SSANNE_EXTERIOR
#define FLAG_WORLD_MAP_SSANNE_EXTERIOR (FLAG_WORLD_MAP_BANK + 0x16)
#undef  FLAG_WORLD_MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL
#define FLAG_WORLD_MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL (FLAG_WORLD_MAP_BANK + 0x17)
#undef  FLAG_WORLD_MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL
#define FLAG_WORLD_MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL (FLAG_WORLD_MAP_BANK + 0x18)
#undef  FLAG_WORLD_MAP_DIGLETTS_CAVE_B1F
#define FLAG_WORLD_MAP_DIGLETTS_CAVE_B1F (FLAG_WORLD_MAP_BANK + 0x19)
#undef  FLAG_WORLD_MAP_VICTORY_ROAD_1F
#define FLAG_WORLD_MAP_VICTORY_ROAD_1F (FLAG_WORLD_MAP_BANK + 0x1A)
#undef  FLAG_WORLD_MAP_ROCKET_HIDEOUT_B1F
#define FLAG_WORLD_MAP_ROCKET_HIDEOUT_B1F (FLAG_WORLD_MAP_BANK + 0x1B)
#undef  FLAG_WORLD_MAP_SILPH_CO_1F
#define FLAG_WORLD_MAP_SILPH_CO_1F (FLAG_WORLD_MAP_BANK + 0x1C)
#undef  FLAG_WORLD_MAP_POKEMON_MANSION_1F
#define FLAG_WORLD_MAP_POKEMON_MANSION_1F (FLAG_WORLD_MAP_BANK + 0x1D)
#undef  FLAG_WORLD_MAP_SAFARI_ZONE_CENTER
#define FLAG_WORLD_MAP_SAFARI_ZONE_CENTER (FLAG_WORLD_MAP_BANK + 0x1E)
#undef  FLAG_WORLD_MAP_POKEMON_LEAGUE_LORELEIS_ROOM
#define FLAG_WORLD_MAP_POKEMON_LEAGUE_LORELEIS_ROOM (FLAG_WORLD_MAP_BANK + 0x1F)
#undef  FLAG_WORLD_MAP_ROCK_TUNNEL_1F
#define FLAG_WORLD_MAP_ROCK_TUNNEL_1F (FLAG_WORLD_MAP_BANK + 0x20)
#undef  FLAG_WORLD_MAP_SEAFOAM_ISLANDS_1F
#define FLAG_WORLD_MAP_SEAFOAM_ISLANDS_1F (FLAG_WORLD_MAP_BANK + 0x21)
#undef  FLAG_WORLD_MAP_POKEMON_TOWER_1F
#define FLAG_WORLD_MAP_POKEMON_TOWER_1F (FLAG_WORLD_MAP_BANK + 0x22)
#undef  FLAG_WORLD_MAP_CERULEAN_CAVE_1F
#define FLAG_WORLD_MAP_CERULEAN_CAVE_1F (FLAG_WORLD_MAP_BANK + 0x23)
#undef  FLAG_WORLD_MAP_POWER_PLANT
#define FLAG_WORLD_MAP_POWER_PLANT (FLAG_WORLD_MAP_BANK + 0x24)
#undef  FLAG_WORLD_MAP_NAVEL_ROCK_EXTERIOR
#define FLAG_WORLD_MAP_NAVEL_ROCK_EXTERIOR (FLAG_WORLD_MAP_BANK + 0x25)
#undef  FLAG_WORLD_MAP_MT_EMBER_EXTERIOR
#define FLAG_WORLD_MAP_MT_EMBER_EXTERIOR (FLAG_WORLD_MAP_BANK + 0x26)
#undef  FLAG_WORLD_MAP_THREE_ISLAND_BERRY_FOREST
#define FLAG_WORLD_MAP_THREE_ISLAND_BERRY_FOREST (FLAG_WORLD_MAP_BANK + 0x27)
#undef  FLAG_WORLD_MAP_FOUR_ISLAND_ICEFALL_CAVE_ENTRANCE
#define FLAG_WORLD_MAP_FOUR_ISLAND_ICEFALL_CAVE_ENTRANCE (FLAG_WORLD_MAP_BANK + 0x28)
#undef  FLAG_WORLD_MAP_FIVE_ISLAND_ROCKET_WAREHOUSE
#define FLAG_WORLD_MAP_FIVE_ISLAND_ROCKET_WAREHOUSE (FLAG_WORLD_MAP_BANK + 0x29)
#undef  FLAG_WORLD_MAP_TRAINER_TOWER_LOBBY
#define FLAG_WORLD_MAP_TRAINER_TOWER_LOBBY (FLAG_WORLD_MAP_BANK + 0x2A)
#undef  FLAG_WORLD_MAP_SIX_ISLAND_DOTTED_HOLE_1F
#define FLAG_WORLD_MAP_SIX_ISLAND_DOTTED_HOLE_1F (FLAG_WORLD_MAP_BANK + 0x2B)
#undef  FLAG_WORLD_MAP_FIVE_ISLAND_LOST_CAVE_ENTRANCE
#define FLAG_WORLD_MAP_FIVE_ISLAND_LOST_CAVE_ENTRANCE (FLAG_WORLD_MAP_BANK + 0x2C)
#undef  FLAG_WORLD_MAP_SIX_ISLAND_PATTERN_BUSH
#define FLAG_WORLD_MAP_SIX_ISLAND_PATTERN_BUSH (FLAG_WORLD_MAP_BANK + 0x2D)
#undef  FLAG_WORLD_MAP_SIX_ISLAND_ALTERING_CAVE
#define FLAG_WORLD_MAP_SIX_ISLAND_ALTERING_CAVE (FLAG_WORLD_MAP_BANK + 0x2E)
#undef  FLAG_WORLD_MAP_SEVEN_ISLAND_TANOBY_RUINS_MONEAN_CHAMBER
#define FLAG_WORLD_MAP_SEVEN_ISLAND_TANOBY_RUINS_MONEAN_CHAMBER (FLAG_WORLD_MAP_BANK + 0x2F)
#undef  FLAG_WORLD_MAP_THREE_ISLAND_DUNSPARCE_TUNNEL
#define FLAG_WORLD_MAP_THREE_ISLAND_DUNSPARCE_TUNNEL (FLAG_WORLD_MAP_BANK + 0x30)
#undef  FLAG_WORLD_MAP_SEVEN_ISLAND_SEVAULT_CANYON_TANOBY_KEY
#define FLAG_WORLD_MAP_SEVEN_ISLAND_SEVAULT_CANYON_TANOBY_KEY (FLAG_WORLD_MAP_BANK + 0x31)
...
// 0xD73..0xD7B allocated below, 0xD7C..0xDC4 is the Battle Net block, 0xDC5..0xEEF empty,
// next used flag 0xEF0 FLAG_DEFEATED_BROCK).
...
// Three one-time claim gates, next in the same verified-free window (0xDC5..0xEEF empty --
