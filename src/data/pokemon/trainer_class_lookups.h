const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_BLUE]               = TRAINER_PIC_CHAMPION_RIVAL_FRLG,
    [FACILITY_CLASS_LANCE]              = TRAINER_PIC_ELITE_FOUR_LANCE_FRLG,
    [FACILITY_CLASS_LORELEI]            = TRAINER_PIC_ELITE_FOUR_LORELEI_FRLG,
    [FACILITY_CLASS_AGATHA]             = TRAINER_PIC_ELITE_FOUR_AGATHA_FRLG,
    [FACILITY_CLASS_GLACIA]             = TRAINER_PIC_ELITE_FOUR_GLACIA,
    [FACILITY_CLASS_DRAKE]              = TRAINER_PIC_ELITE_FOUR_DRAKE,
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_BLUE]               = TRAINER_CLASS_CHAMPION,
    [FACILITY_CLASS_LANCE]              = TRAINER_CLASS_CHAMPION,
    [FACILITY_CLASS_LORELEI]            = TRAINER_CLASS_ELITE_FOUR,
    [FACILITY_CLASS_AGATHA]             = TRAINER_CLASS_ELITE_FOUR,
    [FACILITY_CLASS_GLACIA]             = TRAINER_CLASS_ELITE_FOUR,
    [FACILITY_CLASS_DRAKE]              = TRAINER_CLASS_ELITE_FOUR,
