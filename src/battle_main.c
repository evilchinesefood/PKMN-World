...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HIKER] = { _("HIKER"), 10, BALL_HEAVY },
    [TRAINER_CLASS_TEAM_AQUA] = { _("TEAM AQUA"), 0, BALL_NET },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("{PKMN} BREEDER"), 10, BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] = { _("COOLTRAINER"), 12, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("BIRD KEEPER"), 8, BALL_LEVEL },
    [TRAINER_CLASS_COLLECTOR] = { _("COLLECTOR"), 15, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("SWIMMER♂"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("TEAM MAGMA"), 0, BALL_NEST },
    [TRAINER_CLASS_EXPERT] = { _("EXPERT"), 10, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("AQUA ADMIN"), 10, BALL_NET },
    [TRAINER_CLASS_BLACK_BELT] = { _("BLACK BELT"), 8, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("AQUA LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("HEX MANIAC"), 6, BALL_MOON },
    [TRAINER_CLASS_AROMA_LADY] = { _("AROMA LADY"), 10, BALL_LUXURY },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("RUIN MANIAC"), 15, BALL_DUSK },
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVIEWER"), 12, BALL_REPEAT },
    ...
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéMANIAC"), 15, BALL_PREMIER },
    [TRAINER_CLASS_GUITARIST] = { _("GUITARIST"), 8, BALL_TIMER },
    [TRAINER_CLASS_KINDLER] = { _("KINDLER"), 8 },
    [TRAINER_CLASS_CAMPER] = { _("CAMPER"), 4, BALL_NEST },
    [TRAINER_CLASS_PICNICKER] = { _("PICNICKER"), 4, BALL_NEST },
    [TRAINER_CLASS_BUG_MANIAC] = { _("BUG MANIAC"), 15, BALL_NET },
    [TRAINER_CLASS_PSYCHIC] = { _("PSYCHIC"), 6, BALL_DUSK },
    ...
    [TRAINER_CLASS_WINSTRATE] = { _("WINSTRATE"), 10, BALL_GREAT },
    [TRAINER_CLASS_POKEFAN] = { _("POKéFAN"), 20 },
    [TRAINER_CLASS_YOUNGSTER] = { _("YOUNGSTER"), 4 },
    [TRAINER_CLASS_CHAMPION] = { _("CHAMPION"), 50, BALL_ULTRA },
    [TRAINER_CLASS_FISHERMAN] = { _("FISHERMAN"), 10, BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] = { _("TRIATHLETE"), 10, BALL_FAST },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DRAGON TAMER"), 12, BALL_TIMER },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA BOY"), 3, BALL_QUICK },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("BATTLE GIRL"), 6, BALL_GREAT },
    [TRAINER_CLASS_PARASOL_LADY] = { _("PARASOL LADY"), 10 },
    [TRAINER_CLASS_SWIMMER_F] = { _("SWIMMER♀"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("TWINS"), 3 },
    [TRAINER_CLASS_SAILOR] = { _("SAILOR"), 8, BALL_DIVE },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("COOLTRAINER"), 5, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("MAGMA ADMIN"), 10, BALL_NEST },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} TRAINER"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("BUG CATCHER"), 4, BALL_NET },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 12, BALL_NEST },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("MAGMA LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("LASS"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("YOUNG COUPLE"), 8, BALL_LOVE },
    [TRAINER_CLASS_OLD_COUPLE] = { _("OLD COUPLE"), 10, BALL_LOVE },
    ...
    [TRAINER_CLASS_SAILOR_FRLG] =          { _("SAILOR"), 8, BALL_DIVE },
    [TRAINER_CLASS_CAMPER_FRLG] =          { _("CAMPER"), 5, BALL_NEST },
    [TRAINER_CLASS_PICNICKER_FRLG] =       { _("PICNICKER"), 5, BALL_NEST },
    [TRAINER_CLASS_POKEMANIAC_FRLG] =      { _("POKéMANIAC"), 12, BALL_PREMIER },
    [TRAINER_CLASS_SUPER_NERD_FRLG] =      { _("SUPER NERD"), 6, BALL_REPEAT },
    [TRAINER_CLASS_HIKER_FRLG] =           { _("HIKER"), 9, BALL_HEAVY },
    [TRAINER_CLASS_BIKER_FRLG] =           { _("BIKER"), 5, BALL_FAST },
    [TRAINER_CLASS_BURGLAR_FRLG] =         { _("BURGLAR"), 22 },
    [TRAINER_CLASS_ENGINEER_FRLG] =        { _("ENGINEER"), 12, BALL_HEAVY },
    [TRAINER_CLASS_FISHERMAN_FRLG] =       { _("FISHERMAN"), 9, BALL_LURE },
    [TRAINER_CLASS_SWIMMER_M_FRLG] =       { _("SWIMMER♂"), 1, BALL_DIVE },
    [TRAINER_CLASS_CUE_BALL_FRLG] =        { _("CUE BALL"), 6 },
    [TRAINER_CLASS_GAMER_FRLG] =           { _("GAMER"), 18, BALL_PREMIER },
    [TRAINER_CLASS_BEAUTY_FRLG] =          { _("BEAUTY"), 18 },
    [TRAINER_CLASS_SWIMMER_F_FRLG] =       { _("SWIMMER♀"), 1, BALL_DIVE },
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { _("PSYCHIC"), 5, BALL_DUSK },
    [TRAINER_CLASS_ROCKER_FRLG] =          { _("ROCKER"), 6, BALL_TIMER },
    [TRAINER_CLASS_JUGGLER_FRLG] =         { _("JUGGLER"), 10, BALL_QUICK },
    [TRAINER_CLASS_TAMER_FRLG] =           { _("TAMER"), 10 },
    [TRAINER_CLASS_BIRD_KEEPER_FRLG] =     { _("BIRD KEEPER"), 6, BALL_LEVEL },
    [TRAINER_CLASS_BLACK_BELT_FRLG] =      { _("BLACK BELT"), 6, BALL_ULTRA },
    [TRAINER_CLASS_RIVAL_EARLY_FRLG] =     { _("RIVAL"), 4 },
    [TRAINER_CLASS_SCIENTIST_FRLG] =       { _("SCIENTIST"), 12, BALL_REPEAT },
    [TRAINER_CLASS_BOSS_FRLG] =            { _("BOSS"), 25, BALL_MASTER },
    [TRAINER_CLASS_LEADER_FRLG] =          { _("LEADER"), 25, BALL_ULTRA },
    [TRAINER_CLASS_TEAM_ROCKET_FRLG] =     { _("TEAM ROCKET"), 8, BALL_DUSK },
    ...
    [TRAINER_CLASS_CHAMPION_FRLG] =        { _("CHAMPION"), 25, BALL_ULTRA },
    [TRAINER_CLASS_CHANNELER_FRLG] =       { _("CHANNELER"), 8, BALL_MOON },
    [TRAINER_CLASS_TWINS_FRLG] =           { _("TWINS"), 3 },
    [TRAINER_CLASS_COOL_COUPLE_FRLG] =     { _("COOL COUPLE"), 6, BALL_LOVE },
    [TRAINER_CLASS_YOUNG_COUPLE_FRLG] =    { _("YOUNG COUPLE"), 7, BALL_LOVE },
    [TRAINER_CLASS_CRUSH_KIN_FRLG] =       { _("CRUSH KIN"), 6, BALL_GREAT },
    ...
    [TRAINER_CLASS_CRUSH_GIRL_FRLG] =      { _("CRUSH GIRL"), 6, BALL_GREAT },
    [TRAINER_CLASS_TUBER_FRLG] =           { _("TUBER"), 1, BALL_DIVE },
    [TRAINER_CLASS_PKMN_BREEDER_FRLG] =    { _("{PKMN} BREEDER"), 7, BALL_FRIEND },
    [TRAINER_CLASS_PKMN_RANGER_FRLG] =     { _("{PKMN} RANGER"), 9, BALL_NEST },
    [TRAINER_CLASS_AROMA_LADY_FRLG] =      { _("AROMA LADY"), 7, BALL_LUXURY },
