...
// stopped persisting and regrew on every rezone. There are 293 obstacles, so that cap was
// reached well before the end of a single playthrough.

#define CLEARED_OBSTACLE_COUNT      293   // obstacles present in the map data today
...
#define CLEARED_OBSTACLE_TABLE_HASH 0xCF719B0B
