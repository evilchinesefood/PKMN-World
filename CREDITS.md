...
repository's own `git shortlog`. Beyond those already in the table, that includes **GGbond**,
**PhallenTree**, **Thales Castro** and **Andrew Strauss**, whose upstream battle-engine and UI
fixes are part of this build.
